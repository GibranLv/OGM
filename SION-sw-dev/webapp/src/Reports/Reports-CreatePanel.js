...
class ReportsCreatePanel extends React.Component {
                ...
                <div className="row">
                  <div className="file-field input-field">
                    <div className="btn">
                      ...
                      <input type="file" id="input-c-template" lang="es" onChange={this.handleChangeFile()} />
                    </div>
...
export default ReportsCreatePanel;

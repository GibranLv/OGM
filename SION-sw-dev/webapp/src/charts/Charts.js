...
import ItemVariable from './ItemVariable.js';
    ...
    let fn = (item, index) => {
      ...
      if (device === item.device) {
        return <ItemVariable
          ...
          onChangeName={self.handleChangeName()}
          onChangeColor={self.handleChangeColor()}
      ...
      <div>
        ...
        <div className="col m12">
          <table className="responsive-table centered">
            ...
            <tbody>
              {this.state.variables.map(this.createItemVariable())}
            </tbody>
          </table>
        </div>

...
class GroupsUpdateForm extends Component {
  ...
  handleUpdate() {
    ...
    let fn = (evt) => {
      ...
      let inputType = self.typeRef.current;
      let inputLatitude = self.latitudeRef.current;
      let inputLongitude = self.longitudeRef.current;
        ...
        <div className="row">
          <div className="col-md-12">
            <form onSubmit={this.handleUpdate()} >
              ...
              <div className="col s12 m4">
                <input type="text" id="input-u-type" placeholder="Tipo" ref={this.typeRef} />
              </div>

              <div className="col s12 m2">
                <input type="text" id="input-u-latitude" placeholder="Latitud" ref={this.latitudeRef} />
              </div>

              <div className="col s12 m2">
                <input type="text" id="input-u-longitude" placeholder="Longitud" ref={this.longitudeRef} />
              </div>

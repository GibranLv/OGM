...
import Table from './Groups-Table.js';
import CreateForm from './Groups-CreateForm.js';
import UpdateForm from './Groups-UpdateForm.js';
...
class Groups extends Component {
  ...
  render() {
    ...
    let updateForm = <UpdateForm item={self.state.item} onUpdate={self.updateGroup()} onBack={self.handleBack()} />

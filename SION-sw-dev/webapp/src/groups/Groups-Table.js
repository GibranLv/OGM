...
class GroupsRowTable extends Component {
...
class GroupsTable extends Component {
  ...
  createRow() {
    ...
    let fn = (item, index) => {
      return <GroupsRowTable key={index} row={item} onGet={self.handleGet()} onDelete={self.handleDelete()} />;
    };
  ...
  render() {
    ...
    if (!rows) {
      rows = <tr><td className="center" colSpan="4">Sin grupos registrados</td></tr>;
    }

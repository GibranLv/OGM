...
class CustomRowTable extends React.Component {
  ...
  handleDelete() {
    ...
    let fn = (evt) => {
      ...
      let message = `¿Desea eliminar la variable personalizada: ${name}?`;
    ...
    return (
      <tr>
        ...
        <td>
          ...
          <a title="Borrar" className="btn-floating red" href="#remove" onClick={this.handleDelete()}>
...
class CustomTable extends React.Component {
  ...
  createRow() {
    ...
    let fn = (item) => {
      return <CustomRowTable key={item.id} row={item} onGet={self.handleGet()} onDelete={self.handleDelete()} onOptions={self.handleOptions()} />;
    };
  ...
  render() {
    ...
    if (!rows) {
      rows = <tr><td className="center" colSpan="7">Sin variables personalizadas registradas</td></tr>;
    }

...
import Table from './V-Table.js';
import UpdateForm from './V-UpdateForm.js';
...
class Variables extends React.Component {
  ...
  render() {
    ...
    let updateForm = <UpdateForm item={this.state.item} onUpdate={this.updateVariable()} onBack={this.handleBack()} />

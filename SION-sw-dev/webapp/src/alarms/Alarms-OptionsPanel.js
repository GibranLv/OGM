...
class AlarmsOptionsForm extends Component {
  ...
  handleInsert(value) {
    ...
    let fn = (evt) => {
      ...
      if (value === VARIABLE) {
        selector = self.variableRef;
      } else if (value === CUSTOM_VARIABLE) {
        selector = self.customVariableRef;
      }

      let inputValue = selector.current;
        ...
        <div className="row">
          <div className="col m12">
            <ul className="tabs" id="sion-alarms-panel">
              <li className="tab col s3"><a className="active"  href="#variables">Variables</a></li>
              <li className="tab col s3"><a href="#custom-variables">Variables personalizadas</a></li>
              <li className="tab col s3"><a href="#notifications">Notificaciones</a></li>
            </ul>
          </div>

          <div className="col m12 content-panel sion-content-panel">

            <div id="variables" className="col s12 active">
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-custom-variable" ref={this.customVariableRef} >
                    ...
                    {this.state.custom_variables_.map(this.createOptCustomVariable())}
                  </select>
                </div>
                ...
                <form onSubmit={this.handleUpdateNotification()} >
                  <div className="row">
                    <div className="col s12 m6">
                      <p>
                        <input type="checkbox" id="input-o-send-email" ref={this.sendEmailRef} />
                    ...
                    <div className="col s12 m6">
                      <p>
                        <input type="checkbox" id="input-o-send-sms" ref={this.sendSMSRef} />
...
export default AlarmsOptionsForm;

...
import MatricesCardItemVariable from './Matrices-CardItemVariable.js';

class MatricesCardItemGroup extends React.Component {
  ...
  createSons() {
    ...
    let fn = (son, index) => {
      return <MatricesCardItemGroup key={index} group={son} parent={group.id}
                onSelected={self.handleOnSelected()}
                onDeselected={self.handleOnDeselected()}
                onRemove={self.handleOnRemove()}
                onNextGroup={self.handleOnNext()}
                onNextGroup={self.handleOnBack()}
  ...
  createvariables() {
    ...
    let fn = (variable, index) => {
      return <MatricesCardItemVariable key={index} variable={variable}
...
export default MatricesCardItemGroup;
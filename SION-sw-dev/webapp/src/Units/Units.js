...
import Table from './Units-Table.js';
import Pagination from '../Pagination.js';
import CreateForm from './Units-CreateForm.js';
import UpdateForm from './Units-UpdateForm.js';
...
class Units extends Component {
  ...
  getItem(err, item) {
    ...
    if (err) {
      window.Materialize.toast(err, 2500)(err);
      return;
    }
  ...
  render() {
    ...
    let updateForm = <UpdateForm item={self.state.item} onUpdate={self.updateUnit()} onBack={self.handleBack()} />

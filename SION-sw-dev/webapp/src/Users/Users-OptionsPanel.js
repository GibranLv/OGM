...
class UsersOptionsPanel extends React.Component {
  ...
  componentDidMount() {
    ...
    window.$('ul.tabs').tabs_materialize();
    window.$('ul.tabs').tabs_materialize('select_tab', 'variables');
  }
  ...
  handleInsert(value) {
    ...
    let fn = () => {
      ...
      if (value === VARIABLE) {
        inputValue = self.variableRef.current;

      } else if (value === CUSTOM_VARIABLE) {
        inputValue = self.customVariableRef.current;

      } else if (value === MATRIX) {
        inputValue = self.matrixRef.current;

      } else if (value === REPORT) {
        inputValue = self.reportRef.current;

      } else if (value === ALARM) {
        inputValue = self.alarmRef.current;

      } else if (value === VEHICLE) {
        inputValue = self.vehicleRef.current;
      }
      ...
      if (value === VARIABLE || value === CUSTOM_VARIABLE) {
        return (
          <tr key={index}>
            ...
            <td>
              <a href="#remove" className="waves-effect waves-teal btn-flat sion-link" onClick={self.handleRemove(item, value)}>
          ...
          <div className="col m12 content-panel">
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-variable" ref={this.variableRef}>
                    ...
                    {this.state.variables_.map(this.createOptName(VARIABLE))}
                  </select>
                </div>
                ...
                <div className="col m12" style={{ marginTop: '10px' }}>
                  <table className="table table-hover">
                    <tbody>
                      {this.state.variables.map(this.createItem(VARIABLE))}
                    </tbody>
                  </table>
                </div>
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-custom-variable" ref={this.customVariableRef}>
                    ...
                    {this.state.custom_variables_.map(this.createOptName(CUSTOM_VARIABLE))}
                  </select>
                </div>
                ...
                <div className="col m12" style={{ marginTop: '10px' }}>
                  <table className="table table-hover">
                    <tbody>
                      {this.state.custom_variables.map(this.createItem(CUSTOM_VARIABLE))}
                    </tbody>
                  </table>
                </div>
            ...
            <div id="matrices" className="col s12">
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-matrix" ref={this.matrixRef}>
                    <option value="">Matrices</option>
                    {this.state.matrices_.map(this.createOptName())}
                  </select>
                </div>
                ...
                <div className="col m12" style={{ marginTop: '10px' }}>
                  <table className="table table-hover">
                    <tbody>
                      {this.state.matrices.map(this.createItem(MATRIX))}
                    </tbody>
                  </table>
                </div>
            ...
            <div id="reports" className="col s12">
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-report" ref={this.reportRef}>
                    <option value="">Reportes</option>
                    {this.state.reports_.map(this.createOptName())}
                  </select>
                </div>
                ...
                <div className="col m12" style={{ marginTop: '10px' }}>
                  <table className="table table-hover">
                    <tbody>
                      {this.state.reports.map(this.createItem(REPORT))}
                    </tbody>
                  </table>
                </div>
            ...
            <div id="alarms" className="col s12">
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-alarm" ref={this.alarmRef}>
                    <option value="">Alarmas</option>
                    {this.state.alarms_.map(this.createOptName())}
                  </select>
                </div>
                ...
                <div className="col m12" style={{ marginTop: '10px' }}>
                  <table className="table table-hover">
                    <tbody>
                      {this.state.alarms.map(this.createItem(ALARM))}
                    </tbody>
                  </table>
                </div>
            ...
            <div id="vehicles" className="col s12">
              ...
              <div className="row">
                ...
                <div className="col m4">
                  <select className="browser-default sion-select" id="input-vehicle" ref={this.vehicleRef}>
                    <option value="">Vehiculos</option>
                    {this.state.vehicles_.map(this.createOptName(VEHICLE))}
                  </select>
                </div>
                ...
                <div className="col m12" style={{ marginTop: '10px' }}>
                  <table className="table table-hover">
                    <tbody>
                      {this.state.vehicles.map(this.createItem(VEHICLE))}
                    </tbody>
                  </table>
                </div>
...
export default UsersOptionsPanel;
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/variables/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var _table = __webpack_require__(/*! ./table.jsx */ "./src/variables/table.jsx");

var _table2 = _interopRequireDefault(_table);

var _updateForm = __webpack_require__(/*! ./update-form.jsx */ "./src/variables/update-form.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    key: 'getVariablesForSearch',
    value: function getVariablesForSearch(value) {
      var self = this;

      var url = _constants2.default.URL_SERVER_VARIABLES + '/list?search=' + value;
    ...
    value: function getVariable() {
      ...
      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_VARIABLES + '/' + json.id,
          type: _constants2.default.METHOD_GET,
          dataType: _constants2.default.JSON
        });
    ...
    value: function updateVariable() {
      ...
      var fn = function fn(json, id) {
        ...
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_VARIABLES + '/' + id,
        ...
        if (evt.which == ENTER) {
          ...
          if (search) {
            if (search !== '') {
              ...
              self.getVariablesForSearch(search);
            }
          }
        }
      };
    ...
    value: function render(props, state) {
      ...
      var updateForm = (0, _preact.h)(_updateForm2.default, { item: state.item, onUpdate: self.updateVariable(), onBack: self.handleBack() });
      ...
      var table = function () {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(_table2.default, { items: state.items, onGet: self.getVariable(), onDelete: self.deleteVariable() })
        );
      }();
  ...
  _createClass(RowTable, [{
    ...
    value: function handleDelete() {
      ...
      var fn = function fn() {
        ...
        var message = '\xBFDesea eliminar la variable: ' + device + '.' + name + '?';
...
var UpdateForm = function (_Component) {
  ...
  _createClass(UpdateForm, [{
    ...
    value: function componentDidMount() {
      ...
      if (!o) {
        var msg = 'No se encontró la información de la variable';
        alert(msg);
        return;
      }
      ...
      var inputReadingUnit = document.querySelector('#input-u-reading-unit');
      var inputExpressionInsert = document.querySelector('#input-u-expression-insert');
    ...
    value: function handleUpdate() {
      ...
      var fn = function fn(evt) {
        ...
        var reading_unit = inputReadingUnit.value.trim();
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-reading-unit' },
                  'Unidad de lectura'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-reading-unit', placeholder: 'Unidad de lectura' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-expression-insert' },
                  'Expresi\xF3n de Inserci\xF3n'
                ),
                (0, _preact.h)('textarea', { type: 'text', className: 'form-control', id: 'input-u-expression-insert', placeholder: 'Expresi\xF3n de Inserci\xF3n' })
              ),
              (0, _preact.h)(
                'div',

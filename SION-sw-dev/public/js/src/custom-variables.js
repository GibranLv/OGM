  ...
  _createClass(CreateForm, [{
    ...
    value: function handleCreate() {
      ...
      var fn = function fn(evt) {
        ...
        var inputExpressionInsert = document.querySelector('#input-c-expression-insert');
        ...
        var expression_insert = inputExpressionInsert.value.trim();
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)('textarea', { type: 'text', className: 'form-control', id: 'input-c-expression', placeholder: 'Expresi\xF3n Aritmetica' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-expression-insert' },
                  'Expresi\xF3n de Inserci\xF3n'
                ),
                (0, _preact.h)('textarea', { type: 'text', className: 'form-control', id: 'input-c-expression-insert', placeholder: 'Expresi\xF3n de Inserci\xF3n' })
              ),
              (0, _preact.h)(
                'div',
  ...
  _createClass(CreateForm, [{
    ...
    value: function componentDidMount() {
      ...
      if (o) {
        ...
        inputStatus.value = o.status;

        self.setState({ variables: o.variables });
      }
    }
  }, {
    key: 'getVariables',
...
/***/ })
/******/ ]);
//# sourceMappingURL=custom-variables.js.map
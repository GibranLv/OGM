...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/groups/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var _table = __webpack_require__(/*! ./table.jsx */ "./src/groups/table.jsx");

var _table2 = _interopRequireDefault(_table);

var _createForm = __webpack_require__(/*! ./create-form.jsx */ "./src/groups/create-form.jsx");

var _createForm2 = _interopRequireDefault(_createForm);

var _updateForm = __webpack_require__(/*! ./update-form.jsx */ "./src/groups/update-form.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    key: 'getGroupsForSearch',
    value: function getGroupsForSearch(value) {
      var self = this;

      var url = _constants2.default.URL_SERVER_GROUPS + '/list?search=' + value;
    ...
    value: function getGroup() {
      ...
      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_GROUPS + '/' + json.id,
          type: _constants2.default.METHOD_GET,
          dataType: _constants2.default.JSON
        });
    ...
    value: function addGroup() {
      ...
      var fn = function fn(formData) {
        ...
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_GROUPS,
    ...
    value: function updateGroup() {
      ...
      var fn = function fn(formData, id) {
        ...
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_GROUPS + '/' + id,
    ...
    value: function getItem(err, item) {
      ...
      var form = (0, _preact.h)(_updateForm2.default, { item: item, onUpdate: this.updateGroup(), onCancel: this.handleBack() });
        ...
        if (evt.which == ENTER) {
          ...
          if (search) {
            if (search !== '') {
              ...
              self.getGroupsForSearch(search);
            }
          }
        }
      };
    ...
    value: function render(props, state) {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(_table2.default, { items: state.items, onGet: this.getGroup(), onDelete: this.deleteGroup() }),
        (0, _preact.h)(
          'div',
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(_createForm2.default, { onCreate: this.addGroup(), onCancel: this.handleBack() })
              )
            )
          )
        ),
  ...
  _createClass(CreateForm, [{
    ...
    value: function handleCreate() {
      ...
      var fn = function fn(evt) {
        ...
        var inputName = document.querySelector('#input-c-name');
        var inputType = document.querySelector('#input-c-type');
        var inputLatitude = document.querySelector('#input-c-latitude');
        var inputLongitude = document.querySelector('#input-c-longitude');

        var name = inputName.value.trim();
        var type = inputType.value.trim();
        var latitude = inputLatitude.value.trim();
        var longitude = inputLongitude.value.trim();
        ...
        if (file) {
          formData.append(_constants2.default.MARKER_ICON, file);
        }
    ...
    value: function handleChangeFile() {
      ...
      var fn = function fn(evt) {
        ...
        if (file) {
          ...
          if (file.size > 10000) {
            alert('La imagen excede el tamaño');
            return;
          }
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-type', placeholder: 'Tipo' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-latitude' },
                  'Latitud'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-latitude', placeholder: 'Latitud' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-longitude' },
                  'Longitud'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-longitude', placeholder: 'Longitud' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'custom-file' },
                (0, _preact.h)('input', { type: 'file', className: 'custom-file-input', id: 'input-c-marker-icon', lang: 'es', onChange: this.handleChangeFile() }),
                (0, _preact.h)(
                  'label',
                  { className: 'custom-file-label', 'for': 'input-c-marker-icon' },
                  'Imagen ~75 x 75 px (.png) 10kb'
                )
              ),
              (0, _preact.h)(
                'div',
  ...
  _createClass(UpdateForm, [{
    ...
    value: function componentDidMount() {
      ...
      if (o) {
        ...
        var inputType = document.querySelector('#input-u-type');
        var inputLatitude = document.querySelector('#input-u-latitude');
        var inputLongitude = document.querySelector('#input-u-longitude');
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-type' },
                  'Tipo'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-type', placeholder: 'Tipo' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-latitude' },
                  'Latitud'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-latitude', placeholder: 'Latitud' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-longitude' },
                  'Longitud'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-longitude', placeholder: 'Longitud' })
              ),
              (0, _preact.h)(
                'div',
                { 'class': 'custom-file' },
                (0, _preact.h)('input', { type: 'file', 'class': 'custom-file-input', id: 'input-u-marker-icon', lang: 'es', onChange: this.handleChangeFile() }),
                (0, _preact.h)(
                  'label',
                  { className: 'custom-file-label', 'for': 'input-u-marker-icon' },
                  'Imagen ~75 x 75 px (.png) 10kb'
                )
              ),
              (0, _preact.h)(

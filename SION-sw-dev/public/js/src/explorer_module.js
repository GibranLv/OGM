...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/explorer_module/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/explorer_module/content.jsx":
/*!*****************************************!*\
  !*** ./src/explorer_module/content.jsx ***!
  \*****************************************/
/*! no static exports found */
...
var _createFile = __webpack_require__(/*! ./create-file.jsx */ "./src/explorer_module/create-file.jsx");

var _createFile2 = _interopRequireDefault(_createFile);

var _uploadFile = __webpack_require__(/*! ./upload-file.jsx */ "./src/explorer_module/upload-file.jsx");

var _uploadFile2 = _interopRequireDefault(_uploadFile);

var _file4 = __webpack_require__(/*! ./file.jsx */ "./src/explorer_module/file.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    key: 'serviceWSE',
    value: function serviceWSE() {
      var self = this;

      var v = window.sessionStorage.getItem(_constants2.default.ACCESS_TOKEN_WSE);
      var url = wseURL + '?' + _constants2.default.ACCESS_TOKEN_WSE + '=' + v;
      self.ws = new _websocket.w3cwebsocket(url, _constants2.default.TTX_PROTOCOL);
      ...
      self.ws.onclose = function () {
        ...
        setTimeout(function () {
          var connection_errors = self.state.connection_errors_wse;
      ...
      self.ws.onmessage = function (evt) {
        ...
        if (o.err) {
          ...
          if (o.evt == _constants2.default.EVENT_COPY_FILE || o.evt == _constants2.default.EVENT_MOVE_FILE) {
            var copyFile = self.state.copyFile;
            if (copyFile) {
        ...
        if (o.evt == _constants2.default.EVENT_GET_CONTENT) {
          var _files = o.content;

          for (var _i = 0; _i < _files.length; _i++) {
            _files[_i].copy_ = false;

            var _copyFile = self.state.copyFile;
            if (_copyFile) {
              var f = _files[_i];
              if (f.is_dir) {
                if (f.id != _copyFile.id) {
                  _files[_i].copy_ = true;
                }
              }
            }
          }

          self.setState({ files: _files });
        } else if (o.evt == _constants2.default.EVENT_CREATE_FILE) {
          var file = o.content;
          file.copy_ = false;

          var _files2 = self.state.files;
          _files2.push(file);

          self.setState({ files: _files2 });
        } else if (o.evt == _constants2.default.EVENT_RENAME_FILE) {
          var _file = o.content;
          _file.copy_ = false;

          var _files3 = self.state.files;
          for (var _i2 = 0; _i2 < _files3.length; _i2++) {
            var _f = _files3[_i2];
            if (_f.id == _file.id) {
              for (var key in _file) {
                var hasKey = _file.hasOwnProperty(key);
                if (hasKey) {
                  _files3[_i2][key] = _file[key];
                }
              }
          ...
          self.setState({ files: _files3 });
        } else if (o.evt == _constants2.default.EVENT_DELETE_FILE) {
          var _file2 = o.content;

          var removeCopy = false;
          var _copyFile2 = self.state.copyFile;
          if (_copyFile2) {
            if (_file2.id == _copyFile2.id) {
              removeCopy = true;
            }
          }

          if (removeCopy) {
            var _files4 = self.state.files;
            for (var _i3 = 0; _i3 < _files4.length; _i3++) {
              var _f2 = _files4[_i3];
              _files4[_i3].copy_ = false;

              if (_f2.id == _file2.id) {
                _files4.splice(_i3, 1);
              }
            }

            self.setState({ copyFile: false, files: _files4 }, function () {
              self.getContent();
            });
          } else {
            var _files5 = self.state.files;
            for (var _i4 = 0; _i4 < _files5.length; _i4++) {
              var _f3 = _files5[_i4];
              if (_f3.id == _file2.id) {
                _files5.splice(_i4, 1);
                break;
              }
            }

            self.setState({ files: _files5 });
          }
        } else if (o.evt == _constants2.default.EVENT_COPY_FILE) {
          var _copyFile3 = self.state.copyFile;
          if (_copyFile3) {
            var _files6 = self.state.files;
            for (var _i5 = 0; _i5 < _files6.length; _i5++) {
              _files6[_i5].copy_ = false;
            }

            self.setState({ copyFile: false, files: _files6 }, function () {
              self.getContent();
            });
          }
        } else if (o.evt == _constants2.default.EVENT_MOVE_FILE) {
          var _copyFile4 = self.state.copyFile;
          if (_copyFile4) {
            var _file3 = o.content;
            if (_copyFile4.id == _file3.id) {
              var _files7 = self.state.files;

              for (var _i6 = 0; _i6 < _files7.length; _i6++) {
                _files7[_i6].copy_ = false;
              }

              self.setState({ copyFile: false, files: _files7 }, function () {
                self.getContent();
              });
            }
          }
    ...
    key: 'getTokenWSE',
    value: function getTokenWSE() {
      var self = this;

      var url = _constants2.default.URL_SERVER_USERS + '/tokens?' + _constants2.default.ACCESS_TOKEN_WSE + '=true';
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          ...
          var token_wse = doc.access_token_wse;
          if (token_wse) window.sessionStorage.setItem(_constants2.default.ACCESS_TOKEN_WSE, token_wse);
    ...
    value: function getContent() {
      ...
      var o = {
        evt: _constants2.default.EVENT_GET_CONTENT,
        content: f
      };
    ...
    key: 'handlePath',
    value: function handlePath(index) {
      var self = this;
    ...
    key: 'handleOpenCreateFile',
    value: function handleOpenCreateFile() {
      var self = this;
    ...
    key: 'handleOpenUploadFile',
    value: function handleOpenUploadFile() {
      var self = this;
    ...
    key: 'handleOpenChangeName',
    value: function handleOpenChangeName() {
      var _this2 = this;

      var self = this;

      var fn = function fn(file) {
        if (file) {
          self.state.changeFile = file;

          var inputChangeName = document.querySelector('#input-change-name');
          if (inputChangeName) {
            var name = file.name;
            if (!file.is_dir) {
              var extension = _this2.getExtension(name);
              if (extension) {
                name = _this2.removeExtension(name);
              }
            }
    ...
    value: function handleChangeName() {
      ...
      var fn = function fn(evt) {
        ...
        var changeFile = self.state.changeFile;
        if (changeFile) {
          var inputChangeName = document.querySelector('#input-change-name');
          var nName = inputChangeName.value.trim();
          if (nName == '') return;
          ...
          if (nName === changeFile.name) {
            var message = 'El archivo tiene el mismo nombre';
          ...
          var o = {
            evt: _constants2.default.EVENT_RENAME_FILE,
            content: f
          };
    ...
    value: function handleCopyFile() {
      ...
      var fn = function fn(file) {
        ...
        f.evt_ = _constants2.default.EVENT_COPY_FILE;
    ...
    value: function handleMoveFile() {
      ...
      var fn = function fn(file) {
        ...
        f.evt_ = _constants2.default.EVENT_MOVE_FILE;

        _this3.state.copyFile = f;
    ...
    key: 'handlePasteFile',
    value: function handlePasteFile() {
      var self = this;
      ...
      var fn = function fn(file) {
        ...
        var pathIn = file.path + '/' + file.name;
        ...
        if (copyFile.is_dir) {
          o.evt = _constants2.default.EVENT_MOVE_FILE;
        }
    ...
    key: 'handlePasteOfBtn',
    value: function handlePasteOfBtn() {
      var self = this;
    ...
    value: function handleDeleteFile() {
      ...
      var fn = function fn(id) {
        ...
        var o = {
          evt: _constants2.default.EVENT_DELETE_FILE,
          content: f
        };
    ...
    value: function handleCreateFile() {
      ...
      var fn = function fn(name) {
        ...
        var o = {
          evt: _constants2.default.EVENT_CREATE_FILE,
          content: f
        };
    ...
    value: function handleUploadFile() {
      ...
      var fn = function fn(json) {
        ...
        var s = JSON.stringify(o);
        var size = s.length;
        var cSize = size.toString().length;

        var blob = new Blob([s], { type: file.type });
        blob = new Blob([blob, file], { type: file.type });

        var sizeJSON = [];
        for (var _i7 = cSize; _i7 < 4; _i7++) {
          sizeJSON.push(0);
        }
    ...
    key: 'addExtension',
    value: function addExtension(nName) {
      var file = this.state.changeFile;
      if (file) {
    ...
    value: function createItemPath() {
      ...
      var fn = function fn(item, index) {
        if (item == '.') {
          return (0, _preact.h)(
            'a',
            { href: '#', className: 'breadcrumb', onClick: _this4.handlePath(index) },
            (0, _preact.h)(
              'i',
              { className: 'material-icons', style: 'line-height: 55px; font-size: 48px;' },
              'storage'
            )
          );
        }
    ...
    value: function createItemFile() {
      ...
      var fn = function fn(item, index) {
        return (0, _preact.h)(_file5.default, { key: item.id, file: item,
          onOpen: _this5.handleOpen(),
          onOpenChangeName: _this5.handleOpenChangeName(),
          onCopy: _this5.handleCopyFile(),
          onMove: _this5.handleMoveFile(),
          onPaste: _this5.handlePasteFile(),
          onDelete: _this5.handleDeleteFile() });
      };
    ...
    value: function render(props, state) {
      ...
      if (form == CREATE_FILE) {
        form = (0, _preact.h)(_createFile2.default, { onCreate: this.handleCreateFile(), onCancel: this.handleCancel() });
      } else if (form == UPLOAD_FILE) {
        form = (0, _preact.h)(_uploadFile2.default, { onUpload: this.handleUploadFile(), onCancel: this.handleCancel() });
      }

      return (0, _preact.h)(
        'div',
        null,
        (0, _preact.h)(_header2.default, { module: _constants2.default.EXPLORER_MODULE,
          notifications: notifications,
          onRemoveNotification: this.handleRemoveNotification() }),
        (0, _preact.h)(
          'section',
          { 'class': 'contenedor_root animated fadeIn' },
          (0, _preact.h)(
            'div',
            { className: 'row' },
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'div',
                  { className: 'col s12 explorer-nav-wrapper' },
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'a',
                  { className: 'btn-floating btn-large btn_ttx_rojo' },
                  (0, _preact.h)(
                    'i',
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'a',
                      { onClick: this.handleOpenUploadFile(), className: 'btn-floating green' },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'cloud_upload'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'a',
                      { onClick: this.handleOpenCreateFile(), className: 'btn-floating blue' },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'add'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'a',
                      { onClick: this.handlePasteOfBtn(), className: 'btn-floating yellow darken-1' },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'content_paste'
        ...
        (0, _preact.h)(
          'div',
          { id: 'form-change-name', className: 'modal comment_macro' },
          (0, _preact.h)(
            'div',
            ...
            (0, _preact.h)(
              'form',
              { className: 'formulario', onSubmit: this.handleChangeName() },
              (0, _preact.h)(
                'div',
                { className: 'input-field col s12' },
                (0, _preact.h)('input', { placeholder: 'Nombre', id: 'input-change-name', type: 'text', className: 'validate' })
              ),
              (0, _preact.h)(
                'button',
              ...
              (0, _preact.h)(
                'button',
                { type: 'button', onClick: this.handleCancel(), className: 'modal-action modal-close btn grey darken-3' },
                'Cancelar'
              )
            )
          )
...
/***/ "./src/explorer_module/create-file.jsx":
/*!*********************************************!*\
  !*** ./src/explorer_module/create-file.jsx ***!
  \*********************************************/
/*! no static exports found */
...
var CreateFile = function (_Component) {
  _inherits(CreateFile, _Component);

  function CreateFile(props) {
    _classCallCheck(this, CreateFile);

    return _possibleConstructorReturn(this, (CreateFile.__proto__ || Object.getPrototypeOf(CreateFile)).call(this, props));
  }
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    'label',
                    { htmlFor: 'input-name', className: 'active' },
                    'Nombre'
                  ),
                  (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-name', placeholder: 'Nombre', style: 'color: #080348;' })
                ),
                (0, _preact.h)(
                  'button',
                  { type: 'submit', className: 'btn red' },
                ...
                (0, _preact.h)(
                  'button',
                  { type: 'button', className: 'modal-action modal-close btn grey darken-3', onClick: this.handleCancel() },
                  'Cancelar'
                )
              )
            )
...
var File = function (_Component) {
  ...
  function File(props) {
    ...
    return _possibleConstructorReturn(this, (File.__proto__ || Object.getPrototypeOf(File)).call(this, props));
  }
  ...
  _createClass(File, [{
    ...
    value: function handleDelete() {
      ...
      var fn = function fn(evt) {
        ...
        if (file) {
          ...
          var msg = '\xBFDesea eliminar ' + f + ' ' + file.name + '?';
    ...
    value: function render(props, state) {
      ...
      var srcIcon = '/static/images/explorer/icon_empty_64.png';
      if (file.is_dir) {
        srcIcon = '/static/images/explorer/icon_directory_64.png';
      } else {
        var ext = this.getExtension(file.name);

        if (ext == _constants2.default.EXT_DOC || ext == _constants2.default.EXT_DOCX) {
          srcIcon = '/static/images/explorer/icon_docx_win_64.png';
        } else if (ext == _constants2.default.EXT_GIF) {
          srcIcon = '/static/images/explorer/icon_gif_64.png';
        } else if (ext == _constants2.default.EXT_JPEG || ext == _constants2.default.EXT_JPG) {
          srcIcon = '/static/images/explorer/icon_jpeg_64.png';
        } else if (ext == _constants2.default.EXT_MIDI) {
          srcIcon = '/static/images/explorer/icon_midi_64.png';
        } else if (ext == _constants2.default.EXT_MP3) {
          srcIcon = '/static/images/explorer/icon_mp3_64.png';
        } else if (ext == _constants2.default.EXT_MP4) {
          srcIcon = '/static/images/explorer/icon_mp4_64.png';
        } else if (ext == _constants2.default.EXT_PDF) {
          srcIcon = '/static/images/explorer/icon_pdf_64.png';
        } else if (ext == _constants2.default.EXT_PNG) {
          srcIcon = '/static/images/explorer/icon_png_64.png';
        } else if (ext == _constants2.default.EXT_PPT || ext == _constants2.default.EXT_PPTX) {
          srcIcon = '/static/images/explorer/icon_pptx_win_64.png';
        } else if (ext == _constants2.default.EXT_PUB) {
          srcIcon = '/static/images/explorer/icon_pub_64.png';
        } else if (ext == _constants2.default.EXT_RAR) {
          srcIcon = '/static/images/explorer/icon_rar_64.png';
        } else if (ext == _constants2.default.EXT_TXT) {
          srcIcon = '/static/images/explorer/icon_txt_64.png';
        } else if (ext == _constants2.default.EXT_VSD) {
          srcIcon = '/static/images/explorer/icon_vsd_64.png';
        } else if (ext == _constants2.default.EXT_WAV) {
          srcIcon = '/static/images/explorer/icon_wav_64.png';
        } else if (ext == _constants2.default.EXT_XLS || ext == _constants2.default.EXT_XLSX) {
          srcIcon = '/static/images/explorer/icon_xlsx_win_64.png';
        } else if (ext == _constants2.default.EXT_ZIP) {
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                'td',
                { style: 'padding: 0px; text-align: center; width: 40%;' },
                (0, _preact.h)('img', { src: srcIcon, alt: 'Icono de Archivo', style: 'cursor: pointer; width: 64px; height: 64px; margin-top: 4px;', onDblClick: this.handleOpen() })
              ),
              (0, _preact.h)(
                'td',
                ...
                (0, _preact.h)(
                  'a',
                  { hidden: file.is_dir, href: '/server/explorers/download/' + file.id, target: '_blank' },
                  file.name
                )
              ),
              (0, _preact.h)(
                'td',
                { style: 'padding: 0px; text-align: right; width: 10%;' },
                (0, _preact.h)(
                  'a',
                  { className: 'dropdown-button', href: '#', 'data-activates': 'dropdown' + file.id },
                  (0, _preact.h)(
                    'i',
                    { className: 'material-icons' },
                    'keyboard_arrow_down'
                ...
                (0, _preact.h)(
                  'ul',
                  { id: 'dropdown' + file.id, className: 'dropdown-content' },
                  (0, _preact.h)(
                    'li',
                    { style: 'text-align: center; min-height: 30px;' },
                    (0, _preact.h)(
                      'a',
                      { href: '#', onClick: this.handleChangeName(), style: 'padding: 0px; color: #080348;' },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'edit'
                  ...
                  (0, _preact.h)(
                    'li',
                    { hidden: file.is_dir, style: 'text-align: center; min-height: 30px;' },
                    (0, _preact.h)(
                      'a',
                      { href: '/server/explorers/view/' + file.id, target: '_blank', style: 'padding: 0px; color: #080348;' },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'search'
                  ...
                  (0, _preact.h)(
                    'li',
                    { style: 'text-align: center; min-height: 30px;', hidden: file.is_dir, onClick: this.handleCopy() },
                    (0, _preact.h)(
                      'a',
                      { href: '#', style: 'padding: 0px; color: #080348;' },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'content_copy'
                  ...
                  (0, _preact.h)(
                    'li',
                    { style: 'text-align: center; min-height: 30px;', onClick: this.handleMove() },
                    (0, _preact.h)(
                      'a',
                      { href: '#', style: 'padding: 0px; color: #080348;' },
                      (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    'li',
                    { style: 'text-align: center; min-height: 30px;', hidden: !file.copy_ || !file.is_dir, onClick: this.handlePaste() },
                    (0, _preact.h)(
                      'a',
                      { href: '#', style: 'padding: 0px; color: #080348;' },
                      (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    'li',
                    { style: 'text-align: center; min-height: 30px;', onClick: this.handleDelete() },
                    (0, _preact.h)(
                      'a',
                      { href: '#', style: 'padding: 0px; color: #080348;' },
                      (0, _preact.h)(
...
/***/ "./src/explorer_module/upload-file.jsx":
/*!*********************************************!*\
  !*** ./src/explorer_module/upload-file.jsx ***!
  \*********************************************/
/*! no static exports found */
...
var CreateFile = function (_Component) {
  ...
  function CreateFile(props) {
    ...
    var _this = _possibleConstructorReturn(this, (CreateFile.__proto__ || Object.getPrototypeOf(CreateFile)).call(this, props));
      ...
      var fn = function fn(evt) {
        ...
        if (file) {
          ...
          if (name === '') {
            ...
            if (!extension) {
              var message = 'El archivo no tiene extensión';
            ...
            if (!fileName) {
              var _message = 'El archivo no tiene extensión';
              Materialize.toast(_message, 2500)(_message);
              return;
            }
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)('input', { id: 'input-file', type: 'file', onChange: this.handleChangeFile() })
                  )
                ),
                (0, _preact.h)(
                  'button',
...
/******/ });
//# sourceMappingURL=explorer_module.js.map
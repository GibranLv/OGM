...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/coriolis_module/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/coriolis_module/content.jsx":
/*!*****************************************!*\
  !*** ./src/coriolis_module/content.jsx ***!
  \*****************************************/
/*! no static exports found */
...
var _itemVariable = __webpack_require__(/*! ./item-variable.jsx */ "./src/coriolis_module/item-variable.jsx");

var _itemVariable2 = _interopRequireDefault(_itemVariable);
  ...
  _createClass(Content, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _async.parallel)({
        ...
        var variables_ = res.variables;
        var custom_variables_ = res.custom_variables;

        if (!variables_) variables_ = [];
        if (!custom_variables_) custom_variables_ = [];

        var devices_ = self.getDevices(variables_, custom_variables_);
        ...
        for (var _i = 0; _i < custom_variables_.length; _i++) {
          var custom_variable_ = custom_variables_[_i];
          var _o = {
    ...
    value: function getNotifications() {
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          self.setState({ notifications_: res.docs }, function () {
            $('select').material_select();
          });
      ...
      var fn = function fn(id) {
        ...
        for (var i = 0; i < notifications.length; i++) {
          ...
          if (id == notification.id) {
            ...
            self.setState({ notifications_: notifications }, function () {
              $('select').material_select();
            });
    ...
    key: 'getDevices',
    value: function getDevices(variables, custom_variables) {
      var devices = [];
      ...
      for (var _i2 = 0; _i2 < custom_variables.length; _i2++) {
        var _variable = custom_variables[_i2];
        var _isNew = true;
        for (var _j = 0; _j < devices.length; _j++) {
          var _device = devices[_j];
          if (_variable.device == _device) {
            _isNew = false;
            break;
          }
        }

        if (_isNew) devices.push(_variable.device);
      }
    ...
    key: 'updateVariables',
    value: function updateVariables(json) {
      var self = this;

      var xhr = $.ajax({
        url: _constants2.default.URL_SERVER_CORIOLIS,
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          var message = 'La cambios se guardaron correctamente';
    ...
    key: 'handleInsertAll',
    value: function handleInsertAll() {
      var self = this;
    ...
    value: function handleInsert() {
      ...
      var fn = function fn(evt) {
        ...
        var inputTimestamp = document.querySelector('#input-timestamp');
        ...
        if (inputValue) {
          var _value = inputValue.value;
          if (_value) {
            valueIn = parseFloat(_value);
          }
        }

        if (inputTimestamp) {
          var _value2 = inputTimestamp.value.trim();
          if (_value2) {
            var content = _value2.split(' ');
            if (content.length == 2) {
              var contentDate = content[0];
              var fPart = contentDate.split('-');
              if (!fPart) {
                var message = 'El formato de la fecha es invalido';
                Materialize.toast(message, 2500);
                return;
              }

              if (fPart.length != 3) {
                var _message = 'El formato de la fecha es invalido';
              ...
              if (fPart.length == 3) {
                for (var i = 0; i < 2; i++) {
                  var p = fPart[i];
                  if (p.length != 2) {
                    var _message2 = 'El formato de la fecha es invalido';
              ...
              var contentTime = content[1];
              if (!contentTime) {
                var _message3 = 'El formato de la hora es invalido';
                Materialize.toast(_message3, 2500);
                return;
              }

              var tPart = contentTime.split(':');
              if (tPart.length == 2) {
                contentTime = contentTime + ':00';
              } else if (tPart.length == 1 || tPart.length > 3) {
                var _message4 = 'El formato de la hora es invalido';
                Materialize.toast(_message4, 2500);
                return;
              }

              if (tPart.length == 3) {
                for (var _i3 = 0; _i3 < tPart.length; _i3++) {
                  var _p = tPart[_i3];
                  if (_p.length != 2) {
                    var _message5 = 'El formato de la hora es invalido';
                    Materialize.toast(_message5, 2500);
                    return;
                  }
                }
              }
            ...
            var _message6 = 'El formato de la fecha es invalido';
            Materialize.toast(_message6, 2500);
            return;
          }
        }

        if (variable_id == 0 || timestamp == '') return;
        if (!(0, _underscore.isNumber)(valueIn) || (0, _underscore.isNaN)(valueIn)) return;
    ...
    key: 'getExtra',
    value: function getExtra(o) {
      if (!o.is_custom) {
        var variables = this.state.variables_;
        for (var i = 0; i < variables.length; i++) {
          var v = variables[i];
        ...
        var custom_variables = this.state.custom_variables_;
        for (var _i4 = 0; _i4 < custom_variables.length; _i4++) {
          var _v = custom_variables[_i4];
          if (o.variable_id === _v.id) {
            o.device = _v.device;
            o.name = _v.name;
            break;
          }
    ...
    key: 'createOptDevice',
    value: function createOptDevice() {
      var self = this;
    ...
    value: function createItemVariable() {
      ...
      var fn = function fn(item, index) {
        item.index = index;
        return (0, _preact.h)(_itemVariable2.default, { key: index, item: item, onRemove: self.handleRemove() });
      };
    ...
    value: function render(props, state) {
      ...
      return (0, _preact.h)(
        'div',
        null,
        (0, _preact.h)(_header2.default, { module: _constants2.default.CORIOLIS_MODULE,
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'label',
                        { htmlFor: 'input-value', className: 'active' },
                        '\xA0'
                      ),
                      (0, _preact.h)(
                        'select',
                        { className: 'browser-default sion-select', id: 'input-device', onChange: this.handleChangeDevice() },
                        (0, _preact.h)(
                          'option',
                          null,
                          'Dispositivos'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        ...
                        (0, _preact.h)('input', { id: 'input-value', type: 'text', placeholder: 'Valor' }),
                        (0, _preact.h)(
                          'label',
                          { htmlFor: 'input-value', className: 'active' },
                          'Valor'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'div',
                        { className: 'input-field col s12' },
                        (0, _preact.h)('input', { id: 'input-timestamp', type: 'text', placeholder: 'DD-MM-YYYY HH:MM:SS' }),
                        (0, _preact.h)(
                          'label',
                          { htmlFor: 'input-timestamp', className: 'active' },
                          'Estampa de tiempo'
                        )
                      )
                    )
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'button',
                        { type: 'button', className: 'btn green', onClick: this.handleInsertAll() },
...
/***/ "./src/coriolis_module/item-variable.jsx":
/*!***********************************************!*\
  !*** ./src/coriolis_module/item-variable.jsx ***!
  \***********************************************/
/*! no static exports found */
...
var ItemVariable = function (_Component) {
  _inherits(ItemVariable, _Component);

  function ItemVariable(props) {
    _classCallCheck(this, ItemVariable);

    var _this = _possibleConstructorReturn(this, (ItemVariable.__proto__ || Object.getPrototypeOf(ItemVariable)).call(this, props));

    _this.state = {};
    return _this;
  }

  _createClass(ItemVariable, [{
    key: "handleDelete",
    value: function handleDelete() {
      ...
      var fn = function fn(evt) {
        ...
        var variable = _this2.props.item;
        if (variable) {
    ...
    value: function render(props, state) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            "button",
            { type: "button", className: "btn red", onClick: this.handleDelete() },
            (0, _preact.h)(
              "i",
              { className: "material-icons" },
              "delete"
...
/******/ });
//# sourceMappingURL=coriolis_module.js.map
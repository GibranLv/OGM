...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/login-content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var LoginContent = function (_Component) {
  ...
  _createClass(LoginContent, [{
    ...
    value: function login(json) {
      var xhr = $.ajax({
        url: _constants2.default.URL_SERVER_AUTH + '/login',
    ...
    value: function render() {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'div',
          { className: 'login_body hoverable' },
          (0, _preact.h)(
            'form',
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                'Usuario / Correo electr\xF3nico'
              ),
              (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-username', placeholder: 'Usuario / Correo electr\xF3nico' })
            ),
            (0, _preact.h)(
              'div',
              { className: 'form-group' },
              ...
              (0, _preact.h)('input', { type: 'password', className: 'form-control', id: 'input-password', placeholder: 'Contrase\xF1a' })
            ),
            (0, _preact.h)(
              'button',
              { type: 'submit', className: 'margin_top btn btn_ttx_flat waves-effect' },
              'Iniciar sesi\xF3n'
            ),
            (0, _preact.h)(
              'p',
              { 'class': 't_right', style: 'color: #777;' },
              'O&GM v4 \u2122'
            )
          )
        )
...
(0, _preact.render)((0, _preact.h)(LoginContent, null), document.getElementById('content-main'));

...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/dashboard_module/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/dashboard_module/content.jsx":
/*!******************************************!*\
  !*** ./src/dashboard_module/content.jsx ***!
  \******************************************/
/*! no static exports found */
...
var _variableCard = __webpack_require__(/*! ./variable-card.jsx */ "./src/dashboard_module/variable-card.jsx");

var _variableCard2 = _interopRequireDefault(_variableCard);

var _notification = __webpack_require__(/*! ./notification.jsx */ "./src/dashboard_module/notification.jsx");
...
var Dashboard = function (_Component) {
  ...
  _createClass(Dashboard, [{
    ...
    value: function initChart() {
      if (!window.IsViewMin) {
        var _h = $(window).height() - $('body').height();
        var hMaps = $('.CardsMaps').height();
        var hPanel = $('#sion-panel').height();
        var valueIn = hMaps - hPanel + _h - 24;
        var valueContent = hMaps + _h - 24;

        var valueCSS = valueIn + 'px';
        var valueMap = valueIn - 12 + 'px';
        ...
        var _h2 = $(window).height() - $('body').height();
        var hD = $('.CardsDouble').height();
        var valueMaps = hD + _h2 - 40 + 'px';
        var _valueContent = hD + _h2 - 50 + 'px';

        $('.CardsMaps').css('height', valueMaps);
        $('#sion-container-charts').css('height', _valueContent);
        $('#map').css('height', _valueContent);
      }
      ...
      var variables = this.state.charts_variables;
      var size = variables.length;

      for (var i = 0; i < size; i++) {
        var vOne = variables[i];
        var value = vOne.value;
      ...
      for (var _i = 0; _i < size; _i++) {
        var variableOne = variables[_i];
        var name = variableOne.device;
        variableNames.push(name);

        var _value = variableOne.value;
        console.log(name, _value, (0, _underscore.isNumber)(_value) && !isNaN(_value));
        if ((0, _underscore.isNumber)(_value) && !isNaN(_value)) {
          data.push(_value);
        } else {
          data.push(null);
        }
    ...
    key: 'addMarkers',
    value: function addMarkers(structure, matrix_id) {
      var _this2 = this;
      ...
      if (!(0, _underscore.isArray)(structure)) {
        return;
      }
    ...
    value: function serviceWS() {
      ...
      this.ws.onmessage = function (evt) {
        ...
        if (o.evt == _constants2.default.EVENT_UDAPTE_VARIABLES_VALUE) {
          if (o.content) {
            if ((0, _underscore.isArray)(o.content)) {
              var size = o.content.length;
              if (size <= 15) {
    ...
    key: 'updateVariablesInChart',
    value: function updateVariablesInChart(valuesIn) {
      if (valuesIn) {
        var sizeIn = valuesIn.length;
        var _size = this.state.charts_variables.length;

        for (var i = 0; i < _size; i++) {
          var vOne = this.state.charts_variables[i];
          for (var j = 0; j < sizeIn; j++) {
            var vOneIn = valuesIn[j];
      ...
      var size = this.state.charts_variables.length;
      if (size === 0) return;
      ...
      for (var _i2 = 0; _i2 < size; _i2++) {
        var variable = this.state.charts_variables[_i2];
        var value = variable.value;
        if ((0, _underscore.isNumber)(value) && !isNaN(value)) {
          ...
          if (this.chartOne.series[0].data[_i2]) {
            this.chartOne.series[0].data[_i2].update(value);
          } // else {
    ...
    value: function getMatrices() {
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          var matricesIn = res.docs;
          if (matricesIn.length > 0) {

            for (var i = 0; i < matricesIn.length; i++) {
              var matrixOne = matricesIn[i];
              if (matrixOne.name == 'ACUMULADOS') {
                var structure = matrixOne.structure;
                var variablesIn = self.getVariablesInMatrix(structure);

                self.state.charts_variables = [].concat(_toConsumableArray(variablesIn));
                self.getVariableLastRecords();
              }
            }

            if ((0, _underscore.isNumber)(window.MatrixID)) {
              var positions = [];

              if (window.MatrixID > 0) {

                for (var _i3 = 0; _i3 < matricesIn.length; _i3++) {
                  var matrix = matricesIn[_i3];
                ...
                for (var _i4 = 0; _i4 < positions.length; _i4++) {
                  var position = positions[_i4];
                  var m = matricesIn[position];
                  var _s = m.structure;

                  self.addMarkers(_s, m.id);
                }
              } else {
                if (matricesIn.length > 0) {
                  positions.push(0);
                ...
                for (var _i5 = 0; _i5 < positions.length; _i5++) {
                  var _position = positions[_i5];
                  var _m = matricesIn[_position];
                  var _s2 = _m.structure;

                  self.addMarkers(_s2, _m.id);
                }
              }
            } else if ((0, _underscore.isString)(window.MatrixID)) {
              ...
              try {
                ...
                for (var _i6 = 0; _i6 < aJSON.length; _i6++) {
                  var id = aJSON[_i6];
                  for (var j = 0; j < matricesIn.length; j++) {
                    var _matrix = matricesIn[j];
                    if (_matrix.id == id) {
                      _positions.push(j);
                      break;
                    }
              ...
              for (var _i7 = 0; _i7 < _positions.length; _i7++) {
                var _position2 = _positions[_i7];
                var _m2 = matricesIn[_position2];

                var _s3 = _m2.structure;

                self.addMarkers(_s3, _m2.id);
              }
            }
          }
        } else if (response.status == _constants2.default.STATUS_ACCEPTED) {
    ...
    value: function getNotifications(fn) {
      ...
      var url = _constants2.default.URL_SERVER_LOG_ALARMS + '/list?checked=false';
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          ...
          var notifications = res.docs;
          if (!(0, _underscore.isArray)(notifications)) notifications = [];
    ...
    value: function updateLogAlarm(id, json) {
      ...
      var xhr = $.ajax({
        url: _constants2.default.URL_SERVER_LOG_ALARMS + '/' + id + '/comment',
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          ...
          if (logAlarmIn) {
            var log_alarms = self.state.notifications_;
    ...
    key: 'getDashboardVariables',
    value: function getDashboardVariables(fn) {
      var self = this;

      var url = _constants2.default.URL_SERVER_DASHBOARD_VARIABLES + '/list';
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          ...
          self.setState({ dashboard_variables: res.docs }, function () {
            self.getVariableLastRecords();
          });
        } else if (response.status == _constants2.default.STATUS_ACCEPTED) {
          Materialize.toast(res.message, 2500);
    ...
    value: function getVariablesWithAlarms() {
      ...
      (0, _async.parallel)({
        ...
        var variables = [];
        if (!(0, _underscore.isArray)(alarms)) alarms = [];
    ...
    key: 'updateVariablesValueInDashboard',
    value: function updateVariablesValueInDashboard(content) {
      var self = this;

      if ((0, _underscore.isArray)(content)) {
        var dashboard_variables = self.state.dashboard_variables;
        var size = dashboard_variables.length;
        for (var i = 0; i < size; i++) {
          var dashboard_variable = dashboard_variables[i];
        ...
        self.setState({ dashboard_variables: dashboard_variables }, function () {
          self.getVariablesWithAlarms();
        });
      }
    }
  }, {
    key: 'updateVariablesAlarmInDashboard',
    value: function updateVariablesAlarmInDashboard(variables, alarms) {
      var value_on = 0;
      var value_off = 0;
        ...
        if (v.alarm_id) {
          ...
          if (name) {
            if (name === 'ESTATUS COMPRESOR ON') {
              var isDeprecated = v.variable_id === 25 && v.is_custom === true;
              if (!isDeprecated) {
                value_on = value_on + 1;
              }
            } else if (name === 'ESTATUS COMPRESOR OFF') {
              var _isDeprecated = v.variable_id === 25 && v.is_custom === true;
              if (!_isDeprecated) {
      ...
      var o = { value_on: value_on, value_off: value_off };
      this.setState(o);
    }
  }, {
      ...
      for (var i = 0; i < s.length; i++) {
        ...
        if (g.variables) {
          for (var j = 0; j < g.variables.length; j++) {
            ...
            var v = { id: variable.id, is_custom: variable.is_custom, name: variable.name, device: variable.device };
            variables_.push(v);
          }
        }

        for (var _j = 0; _j < variables_.length; _j++) {
          var _variable = variables_[_j];
    ...
    value: function handleChangeLogAlarm() {
      var self = this;
    ...
    key: 'createVariableCard',
    value: function createVariableCard() {
      var fn = function fn(item, index) {
        return (0, _preact.h)(_variableCard2.default, { key: index, variable: item });
      };
    ...
    value: function createNotification() {
      ...
      var fn = function fn(item, index) {
        ...
        return (0, _preact.h)(_notification2.default, { key: index, notification: item, onSeen: _this3.handleChangeLogAlarm() });
      };
    ...
    key: 'getView',
    value: function getView(notifications) {
      return (0, _preact.h)(
        'div',
        { className: 'CardsDouble' },
        (0, _preact.h)(
          'div',
          { className: 'CardsAlarms' },
          (0, _preact.h)(
            'h4',
            null,
            'Alarmas'
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              'ul',
              { className: 'tabs', id: 'sion-panel' },
              (0, _preact.h)(
                'li',
                { className: 'tab col s2' },
                (0, _preact.h)(
                  'a',
                  { className: 'active', href: '#chart-variables' },
                  'Gr\xE1fica'
                )
              ),
              (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              'div',
              { id: 'chart-variables', className: 'col s12' },
              (0, _preact.h)('div', { id: 'sion-container-charts' })
            ),
            (0, _preact.h)(
              'div',
              { id: 'map-variables', className: 'col s12' },
              (0, _preact.h)(
                'h5',
                null,
                'Instalaciones'
    ...
    key: 'getViewWithoutAlarms',
    value: function getViewWithoutAlarms() {
      return (0, _preact.h)(
        'div',
        { className: 'CardsDouble' },
        (0, _preact.h)(
    ...
    value: function render() {
      var notifications = this.state.notifications_;
      var dashboard_variables = this.state.dashboard_variables;

      var value_on = this.state.value_on;
      var value_off = this.state.value_off;

      var viewsBottom = false;
      ...
      return (0, _preact.h)(
        'div',
        null,
        (0, _preact.h)(_header2.default, { module: _constants2.default.DASHBOARD_MODULE,
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'div',
                        { className: 'col s12 m2 t_right Verde' },
                        (0, _preact.h)(
                          'h3',
                          null,
                          (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'div',
                        { className: 'col s12 m2 t_right Danger' },
                        (0, _preact.h)(
                          'h3',
                          null,
                          (0, _preact.h)(
...
(0, _preact.render)((0, _preact.h)(Dashboard, null), document.getElementById('content-main'));

/***/ }),

/***/ "./src/dashboard_module/notification.jsx":
/*!***********************************************!*\
  !*** ./src/dashboard_module/notification.jsx ***!
  \***********************************************/
/*! no static exports found */
  ...
  _createClass(Notification, [{
    ...
    value: function handleSeen() {
      ...
      var fn = function fn(evt) {
        ...
        var notification = _this2.props.notification;

        var fn = _this2.props.onSeen;
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              'a',
              { href: '#', onClick: this.handleSeen() },
              (0, _preact.h)('i', { className: 'fa fa-close', style: 'display:vertical-align: bottom;' })
            )
          )
        )
      );
...
/***/ "./src/dashboard_module/variable-card.jsx":
/*!************************************************!*\
  !*** ./src/dashboard_module/variable-card.jsx ***!
  \************************************************/
/*! no static exports found */
...
var VariableCard = function (_Component) {
  _inherits(VariableCard, _Component);

  function VariableCard(props) {
    _classCallCheck(this, VariableCard);

    return _possibleConstructorReturn(this, (VariableCard.__proto__ || Object.getPrototypeOf(VariableCard)).call(this, props));
  }

  _createClass(VariableCard, [{
    key: "render",
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          "div",
          { className: "col s12 m12 t_center" },
          (0, _preact.h)(
            "h3",
            null,
            (0, _preact.h)(
...
/******/ });
//# sourceMappingURL=dashboard_module.js.map
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/custom_variables/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/custom_variables/content.jsx":
/*!******************************************!*\
  !*** ./src/custom_variables/content.jsx ***!
  \******************************************/
/*! no static exports found */
...
var _table = __webpack_require__(/*! ./table.jsx */ "./src/custom_variables/table.jsx");

var _table2 = _interopRequireDefault(_table);

var _createForm = __webpack_require__(/*! ./create-form.jsx */ "./src/custom_variables/create-form.jsx");

var _createForm2 = _interopRequireDefault(_createForm);

var _updateForm = __webpack_require__(/*! ./update-form.jsx */ "./src/custom_variables/update-form.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    key: 'getCustomVariablesForSearch',
    value: function getCustomVariablesForSearch(value) {
      var self = this;

      var url = _constants2.default.URL_SERVER_CUSTOM_VARIABLES + '/list?search=' + value;
    ...
    key: 'getCustomVariable',
    value: function getCustomVariable() {
      var self = this;

      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_CUSTOM_VARIABLES + '/' + json.id,
          type: _constants2.default.METHOD_GET,
          dataType: _constants2.default.JSON
        });
    ...
    value: function addCustomVariable() {
      var self = this;

      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_CUSTOM_VARIABLES,
    ...
    key: 'updateCustomVariable',
    value: function updateCustomVariable() {
      var self = this;

      var fn = function fn(json, id) {

        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_CUSTOM_VARIABLES + '/' + id,
    ...
    key: 'deleteCustomVariable',
    value: function deleteCustomVariable() {
      var self = this;
        ...
        if (evt.which == ENTER) {
          ...
          if (search) {
            if (search !== '') {
              ...
              self.getCustomVariablesForSearch(search);
            }
          }
        }
      };
    ...
    value: function render(props, state) {
      ...
      var createForm = (0, _preact.h)(_createForm2.default, { onCreate: self.addCustomVariable(), onBack: self.handleBack() });
      var updateForm = (0, _preact.h)(_updateForm2.default, { item: state.item, onUpdate: self.updateCustomVariable(), onBack: self.handleBack() });
      ...
      var table = function () {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(_table2.default, { items: state.items, onGet: self.getCustomVariable(), onDelete: self.deleteCustomVariable() })
        );
      }();
...
/***/ "./src/custom_variables/create-form.jsx":
/*!**********************************************!*\
  !*** ./src/custom_variables/create-form.jsx ***!
  \**********************************************/
/*! no static exports found */
  ...
  _createClass(CreateForm, [{
    ...
    value: function handleCreate() {
      ...
      var fn = function fn(evt) {
        ...
        var inputDevice = document.querySelector('#input-c-device');
        ...
        var device = inputDevice.value.trim();
        ...
        if (size == 0) {
          alert('La lista de variables esta vacia');
          return;
        }

        if (expression == '') {
          alert('La expresión es nula');
          return;
        }
        ...
        for (var i = 0; i < size; i++) {
          ...
          if (id) {
            var old = '${' + variable.device + '.' + variable.name + '}';
            var n = '${' + id + '}';
    ...
    value: function handleInsert() {
      ...
      var fn = function fn() {
        ...
        var sId = inputVariable.value.trim();
        ...
        var items = self.state.variables_;
    ...
    value: function createItem() {
      ...
      var fn = function fn(item, index) {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(
            'button',
            { type: 'button', className: 'close', 'data-dismiss': 'modal', 'aria-label': 'Close', onClick: self.handleRemove(item.id) },
            (0, _preact.h)(
              'span',
              { 'aria-hidden': 'true' },
              '\xD7'
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-device' },
                  'Dispositivo'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-device', placeholder: 'Dispositivo' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  ...
                  'Expresi\xF3n Aritmetica',
                  (0, _preact.h)('br', null),
                  '${DEVICE.VARIABLE}: Clave de la variable'
                ),
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-unit', placeholder: 'Ejemplo: Pa, Kg/cm2, PSI' })
              ),
              (0, _preact.h)(
                'div',
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    state.variables_.map(this.createOptName())
                  )
                ),
                (0, _preact.h)(
                  'div',
                  ...
                  (0, _preact.h)(
                    'button',
                    { type: 'button', className: 'btn btn-primary', onClick: this.handleInsert() },
                    (0, _preact.h)(
                      'i',
                      { className: 'material-icons' },
                      'add'
...
/***/ "./src/custom_variables/table.jsx":
/*!****************************************!*\
  !*** ./src/custom_variables/table.jsx ***!
  \****************************************/
/*! no static exports found */
  ...
  _createClass(RowTable, [{
    ...
    value: function handleDelete() {
      ...
      var fn = function fn() {
        ...
        var message = '\xBFDesea eliminar la variable personalizada: ' + name + '?';
    ...
    value: function render() {
      ...
      if (!rows) {
        rows = (0, _preact.h)(
          ...
          (0, _preact.h)(
            'td',
            { className: 'center', colSpan: '7' },
            'Sin variables personalidas registradas'
          )
        );
      }
...
/***/ "./src/custom_variables/update-form.jsx":
/*!**********************************************!*\
  !*** ./src/custom_variables/update-form.jsx ***!
  \**********************************************/
/*! no static exports found */
...
var CreateForm = function (_Component) {
  ...
  _createClass(CreateForm, [{
    ...
    value: function getVariables() {
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          self.setState({ variables_: res.docs }, function () {
            var o = self.props.item;
            if (o) {
              var expression = o.expression;

              var variablesIn = o.variables_json;
              if (variablesIn) {
                var variables = [];
                for (var i = 0; i < variablesIn.length; i++) {
                  var id = variablesIn[i];
                  var variables_ = self.state.variables_;
                  for (var j = 0; j < variables_.length; j++) {
                    var variable_ = variables_[j];
                    if (id == variable_.id) {
                      variables.push(variable_);

                      var old = '${' + id + '}';
                      var n = '${' + variable_.device + '.' + variable_.name + '}';
                      expression = self.replaceAll(expression, old, n);
                    }
                  }
                }
    ...
    value: function handleUpdate() {
      ...
      var fn = function fn(evt) {
        ...
        var o = self.props.item;
        if (!o) {
          alert('No se encontro la información de la variable');
          return;
        }
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-device' },
                  'Dispositivo'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-device', placeholder: 'Dispositivo' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-unit', placeholder: 'Ejemplo: Pa, Km/cm2, PSI' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-check' },
...
/******/ });
//# sourceMappingURL=custom_variables.js.map
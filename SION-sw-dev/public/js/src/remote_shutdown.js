...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/remote_shutdown_module/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'p',
                      null,
                      'Servicio de Monitoreo de Motocompresion BNA'
                    )
                  )
                )
              )
...
/***/ "./src/remote_shutdown_module/content.jsx":
/*!************************************************!*\
  !*** ./src/remote_shutdown_module/content.jsx ***!
  \************************************************/
/*! no static exports found */
...
var ShutdownStopContent = function (_Component) {
  _inherits(ShutdownStopContent, _Component);

  function ShutdownStopContent(props) {
    _classCallCheck(this, ShutdownStopContent);

    return _possibleConstructorReturn(this, (ShutdownStopContent.__proto__ || Object.getPrototypeOf(ShutdownStopContent)).call(this, props));
  }

  _createClass(ShutdownStopContent, [{
    key: 'componentDidMount',
    value: function componentDidMount() {}
  }, {
    key: 'handleSubmit',
    ...
    value: function render(props, state) {
      ...
      return (0, _preact.h)(
        'div',
        null,
        (0, _preact.h)(_header2.default, { o: o, module: _constants2.default.SHUTDOWN_REMOTE_MODULE }),
        (0, _preact.h)(
          'section',
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'div',
                        { className: ' col s12', style: 'margin: 15px 0px;' },
                        (0, _preact.h)(
                          'select',
                          { className: 'browser-default sion-select' },
                          (0, _preact.h)(
                          ...
                          (0, _preact.h)(
                            'option',
                            { value: '1' },
                            'Gaylord Ram\xEDrez Mart\xEDnez'
                          ),
                          (0, _preact.h)(
                            'option',
                            { value: '2' },
                      ...
                      (0, _preact.h)(
                        ...
                        (0, _preact.h)('input', { placeholder: '{Usuario Seleccionado}', id: 'input-user', type: 'text', disabled: true, selected: true })
                      ),
                      (0, _preact.h)(
                        'div',
                        { className: 'input-field col s12' },
                        (0, _preact.h)('input', { placeholder: 'Contrase\xF1a', id: 'input-password', type: 'password', className: 'validate' })
                      )
                    )
                  ),
                  (0, _preact.h)(
                    'div',
                    { className: 'col s12 m7 panic' },
                    (0, _preact.h)(
                      'div',
                      { className: 'flexi animated fadeIn' },
                      (0, _preact.h)(
                        'div',
                        { className: 'btn_paro pulse' },
                        (0, _preact.h)(
                          'a',
                    ...
                    (0, _preact.h)(
                      'p',
                      { className: 'animated fadeIn' },
                      'Esperando confirmaci\xF3n...'
                    ),
                    (0, _preact.h)(
                      'p',
                      { className: 'animated fadeIn' },
                      'Env\xEDo de paro remoto exitoso...'
                    )
                  )
                )
              )
  ...
  return ShutdownStopContent;
}(_preact.Component);

(0, _preact.render)((0, _preact.h)(ShutdownStopContent, null), document.getElementById('content-main'));

/***/ })

/******/ });
//# sourceMappingURL=remote_shutdown.js.map
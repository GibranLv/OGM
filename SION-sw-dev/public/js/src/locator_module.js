...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/locator_module/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/locator_module/content.jsx":
/*!****************************************!*\
  !*** ./src/locator_module/content.jsx ***!
  \****************************************/
/*! no static exports found */
...
var _reportForm = __webpack_require__(/*! ./report-form.jsx */ "./src/locator_module/report-form.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    value: function serviceWS() {
      ...
      this.ws.onmessage = function (evt) {
        ...
        try {
          ...
          if (o.evt == _constants2.default.EVENT_UDAPTE_VEHICLE) {
            var content = o.content;
            if (content) {
              var vehicleId = content.vehicle_id;
              if (vehicleId) {
                var vehicles = self.state.vehicles;
                var size = vehicles.length;
                ...
                var markers = self.state.markers_;
                size = markers.length;

                for (var _i = 0; _i < size; _i++) {
                  var marker = markers[_i];
                  if (marker) {
                    var _vehicle = marker.vehicle;
                    if (_vehicle) {
                      if (_vehicle.id == vehicleId) {
                        markers[_i].vehicle.speed = speed;
                        markers[_i].vehicle.timestamp = timestamp;

                        if (contentTitle) {
                          if (markers[_i].infoWindow) {
                            markers[_i].infoWindow.setContent(contentTitle);
                          }
                        }

                        markers[_i].setPosition({ lat: content.latitude, lng: content.longitude });
                        break;
                      }
                    }
                  }
    ...
    value: function getVehicles() {
      ...
      var url = _constants2.default.URL_SERVER_VEHICLES + '/list?user_id=self';
    ...
    value: function updateVisibilityVehicle() {
      ...
      var fn = function fn(json, id) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_VEHICLES + '/' + id + '/visibility',
          type: _constants2.default.METHOD_PUT,
          contentType: _constants2.default.APPLICATION_JSON,
      ...
      for (var i = 0; i < size; i++) {
        ...
        if (vehicle) {
          (function () {
            ...
            var latLng = { lat: vehicle.latitude, lng: vehicle.longitude };
            ...
            if (vehicle.marker_icon) {
              var marker_icon = vehicle.marker_icon;
              var image = '/static/images/vehicles/' + marker_icon;
    ...
    value: function removeMarkers() {
      var markers_ = this.state.markers_;
      if (markers_) {
    ...
    key: 'updateItem',
    value: function updateItem(err, o) {
      var self = this;
      ...
      if (o.vehicle_id) {
        ...
        this.setState({ vehicles: vehicles }, function () {
          self.removeMarkers();
          self.addMarkers();
        });
      }
    ...
    key: 'handleGetReport',
    value: function handleGetReport() {
      var self = this;

      var fn = function fn(json) {
        if (self.ws) {
          var o = {
            evt: _constants2.default.EVENT_REQUEST_REPORT_LOCATOR,
            content: json
          };
          ...
          try {
            ...
            var message = 'Ocurrió un error al solicitar el reporte';
    ...
    value: function handleItemVehicleReport() {
      ...
      var fn = function fn(vehicle) {
        self.setState({ view: (0, _preact.h)(_reportForm2.default, { vehicle: vehicle, onGetReport: self.handleGetReport(), onCancel: self.handleCancel() }) });
        $('.button-collapse').sideNav('hide');
      };
    ...
    value: function render(props, state) {
      ...
      var o = { vehicles: state.vehicles };

      return (0, _preact.h)(
        'div',
        null,
        (0, _preact.h)(_header2.default, { o: o, module: _constants2.default.LOCATOR_MODULE,
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              { className: 'settings' },
              state.view,
              (0, _preact.h)('div', { hidden: state.view, id: 'map', style: 'height:500px; width:100%; z-index: 1' })
            )
          )
        )
      );
...
/***/ "./src/locator_module/report-form.jsx":
/*!********************************************!*\
  !*** ./src/locator_module/report-form.jsx ***!
  \********************************************/
/*! no static exports found */
...
var ReportForm = function (_Component) {
  ...
  function ReportForm(props) {
    ...
    return _possibleConstructorReturn(this, (ReportForm.__proto__ || Object.getPrototypeOf(ReportForm)).call(this, props));
  }
  ...
  _createClass(ReportForm, [{
    ...
    key: 'getPointsOfVehicle',
    value: function getPointsOfVehicle(json) {
      var self = this;

      var xhr = $.ajax({
        url: _constants2.default.URL_SERVER_VEHICLES + '/points',
    ...
    value: function handleGetReport() {
      ...
      var fn = function fn(evt) {
        ...
        var vehicle = self.props.vehicle;
        if (!vehicle) {
          var message = 'No se pudo obtener la información del vehiculo';
          alert(message);
          return;
        }

        var inputDateOf = document.querySelector('#input-date-of');
        var inputTimeOf = document.querySelector('#input-time-of');
        var inputDateTo = document.querySelector('#input-date-to');
        var inputTimeTo = document.querySelector('#input-time-to');
        var inputSpeed = document.querySelector('#input-speed');
        ...
        var speed = inputSpeed.value.trim();

        if (dateOf == '') {
          var _message = 'Fecha de, campo requerido';
          alert(_message);
          return;
        }

        if (dateTo == '') {
          var _message2 = 'A, campo requerido';
          alert(_message2);
          return;
        }

        if (timeOf == '') {
          var _message3 = 'Hora de, campo requerido';
          alert(_message3);
          return;
        }

        if (timeTo == '') {
          var _message4 = 'Hora de, campo requerido';
          alert(_message4);
          return;
        }
        ...
        var srcMap = $('#static-map').attr('src');
        if (srcMap) {
          var canvas = document.getElementById('canvas-static-map');
    ...
    key: 'handleGetPoints',
    value: function handleGetPoints() {
      var self = this;
      ...
      var fn = function fn(evt) {
        ...
        if (dateOf == '') {
          var _message5 = 'Fecha de, campo requerido';
          alert(_message5);
          return;
        }

        if (dateTo == '') {
          var _message6 = 'A, campo requerido';
          alert(_message6);
          return;
        }

        if (timeOf == '') {
          var _message7 = 'Hora de, campo requerido';
          alert(_message7);
          return;
        }

        if (timeTo == '') {
          var _message8 = 'Hora de, campo requerido';
          alert(_message8);
          return;
        }
    ...
    value: function handleGetImage() {
      ...
      var fn = function fn(evt) {
        ...
        if (self.map) {
          ...
          var width = $('#preview-map').width();
          if (!width) {
            width = 600;
          }

          var urlMap = 'https://maps.googleapis.com/maps/api/staticmap?size=' + width + 'x300&maptype=roadmap';

          if (!self.flightPaths) {
            self.flightPaths = [];
          }

          var size = self.flightPaths.length;
          for (var i = 0; i < size; i++) {
            var flightPath = self.flightPaths[i];
            var pathOut = flightPath.getPath();
            var points = pathOut.getArray();
    ...
    key: 'insertPointsInMap',
    value: function insertPointsInMap(err, points) {
      if (err) {
        alert(err);
        return;
      }
    ...
    value: function render(props, state) {
      return (0, _preact.h)(
        'div',
        { className: 'row' },
        (0, _preact.h)('div', { className: 'col s2' }),
        (0, _preact.h)(
          'div',
          { className: 'col s8' },
          (0, _preact.h)(
            'div',
            { className: 'col s12', style: 'text-align: center;' },
            (0, _preact.h)(
              'h5',
              null,
              'Reporte de Vehiculo: ',
          ...
          (0, _preact.h)(
            'form',
            { className: 'formulario', onSubmit: this.handleGetReport() },
            (0, _preact.h)(
              'div',
              { className: 'col s12' },
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-date-of' },
                  'Fecha de'
                ),
                (0, _preact.h)('input', { type: 'date', id: 'input-date-of', className: 'datepicker' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'input-field col s6' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-time-of' },
                  'Hora de'
                ),
                (0, _preact.h)('input', { type: 'text', id: 'input-time-of', className: 'timepicker', style: 'border-bottom: 1px solid #9e9e9e;' })
              )
            ),
            (0, _preact.h)(
              'div',
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)('input', { type: 'date', id: 'input-date-to', className: 'datepicker' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'input-field col s6' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-time-to' },
                  'Hora de'
                ),
                (0, _preact.h)('input', { type: 'text', id: 'input-time-to', className: 'timepicker', style: 'border-bottom: 1px solid #9e9e9e;' })
              )
            ),
            (0, _preact.h)(
              'div',
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'select',
                  { className: 'browser-default sion-select', id: 'input-speed' },
                  (0, _preact.h)(
                    'option',
                    { value: '1' },
                    'Incluir velocidad mayor a 0 km/h'
                  ),
                  (0, _preact.h)(
                    'option',
                    { value: '2' },
                    'Incluir velocidad de 0 km/h'
                  )
                )
              ),
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'button',
                  { type: 'button', className: 'btn waves-effect blue', onClick: this.handleGetPoints() },
                  (0, _preact.h)(
                    'i',
                    { className: 'material-icons', style: 'line-height: 38px;' },
                    'timeline'
                  )
                ),
                (0, _preact.h)(
                  'button',
                  { type: 'button', className: 'btn waves-effect blue', onClick: this.handleGetImage() },
                  (0, _preact.h)(
                    'i',
                    { className: 'material-icons', style: 'line-height: 38px;' },
                    'image'
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    'a',
                    { id: 'link-report', className: 'waves-effect waves-light blue btn', href: '#' },
                    'Descargar',
                    (0, _preact.h)(
                      'i',
                      { className: 'material-icons right' },
            ...
            (0, _preact.h)(
              'div',
              { className: 'col s12' },
              (0, _preact.h)('img', { id: 'static-map', src: '/static/images/logo_ogm.svg', alt: 'Imagen del recorrido', style: 'height:300px; width:100%; display: none;' }),
              (0, _preact.h)('div', { id: 'preview-map', style: 'height:300px; width:100%;' })
            ),
            (0, _preact.h)(
              'div',
              { className: 'col s12' },
...
/******/ });
//# sourceMappingURL=locator_module.js.map
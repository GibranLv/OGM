...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    value: function serviceWSA() {
      ...
      this.wsa = new _websocket.w3cwebsocket(wsaURL, _constants2.default.TTX_PROTOCOOL);
    ...
    value: function getTokenWSA() {
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          ...
          if (token_wsa) Cookies.set(_constants2.default.ACCESS_TOKEN_WSA, token_wsa, { expires: sixtySeconds });
    ...
    value: function updateSoundStatus() {
      ...
      if (active) {
        ...
        if (active.sound == _constants2.default.DANGER_VALUE) {
          if (src.indexOf(_constants2.default.DANGER_SOUND) < 0) self.Audio.src = _constants2.default.DANGER_SOUND;
        } else if (active.sound == _constants2.default.WARNING_VALUE) {
          if (src.indexOf(_constants2.default.WARNING_SOUND) < 0) self.Audio.src = _constants2.default.WARNING_SOUND;
        } else if (active.sound == _constants2.default.TIMEOUT_VALUE) {
          if (src.indexOf(_constants2.default.TIMEOUT_SOUND) < 0) self.Audio.src = _constants2.default.TIMEOUT_SOUND;
        }

        if (self.Audio.src) self.Audio.play();
        return;
      }
    ...
    value: function updateVariablesAlarm(groups, variable_id, is_custom, color) {
      for (var i = 0; i < groups.length; i++) {
        var g = groups[i];
        var variables = g.variables;
        if (variables) {
          ...
          if (g.sons) {
            groups[i].sons = this.updateVariablesAlarm(g.sons, variable_id, is_custom, color);
          }
        }
      }
    ...
    value: function render(props, state) {
      ...
      if (state.view == LIST_VIEW) {
        ...
        //view = <CardViewInline structure={s} />;
        view = false;
...
/*
  <li className="list-group-item">{ son.name }
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'a',
                  { href: '/graphic/' + variable_id, style: 'color: #EDEDED' },
                  '\xA0\xA0\xA0',
                  variable_name
                )
              ),
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    'a',
                    { href: '#', onClick: this.handleOpenComment(),
...
/*
        ...
        <div className="actions_var">
          <a href="#"><i className="material-icons right">access_time</i></a>
          <a href="#"><i className="material-icons right">portable_wifi_off</i></a>
          <a href="#"><i className="material-icons right">volume_up</i></a>
          <a href="#"><i className="material-icons right">mode_comment</i></a>
        </div>
...
/******/ });
//# sourceMappingURL=matrix_module.js.map
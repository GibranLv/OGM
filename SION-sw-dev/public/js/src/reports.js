...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/reports/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/reports/card-item-group.jsx":
/*!*****************************************!*\
  !*** ./src/reports/card-item-group.jsx ***!
  \*****************************************/
/*! no static exports found */
...
var _cardItemVariable = __webpack_require__(/*! ./card-item-variable.jsx */ "./src/reports/card-item-variable.jsx");
...
/***/ "./src/reports/card-item-variable.jsx":
/*!********************************************!*\
  !*** ./src/reports/card-item-variable.jsx ***!
  \********************************************/
/*! no static exports found */
...
var _table = __webpack_require__(/*! ./table.jsx */ "./src/reports/table.jsx");

var _table2 = _interopRequireDefault(_table);

var _createPanel = __webpack_require__(/*! ./create-panel.jsx */ "./src/reports/create-panel.jsx");

var _createPanel2 = _interopRequireDefault(_createPanel);

var _updatePanel = __webpack_require__(/*! ./update-panel.jsx */ "./src/reports/update-panel.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    value: function getReports() {
      ...
      var url = _constants2.default.URL_SERVER_REPORTS + '/list?with_structure=true&with_structure_json=false';
    ...
    key: 'getReportsForSearch',
    value: function getReportsForSearch(value) {
      var self = this;

      var url = _constants2.default.URL_SERVER_REPORTS + '/list?search=' + value;
    ...
    value: function getReport() {
      ...
      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_REPORTS + '/' + json.id + '?with_structure=true&with_structure_json=false',
          type: _constants2.default.METHOD_GET,
          dataType: _constants2.default.JSON
        });
    ...
    value: function addReport() {
      ...
      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_REPORTS,
    ...
    value: function updateReport() {
      ...
      var fn = function fn(json, id) {
        ...
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_REPORTS + '/' + id,
    ...
    value: function deleteReport() {
      ...
      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_REPORTS + '/' + json.id,
        ...
        if (evt.which == ENTER) {
          ...
          if (search) {
            if (search !== '') {
              ...
              self.getReportsForSearch(search);
            }
          }
        }
      };
    ...
    value: function render(props, state) {
      ...
      var createForm = (0, _preact.h)(_createPanel2.default, { onCreate: self.addReport(), onBack: self.handleBack() });
      var updateForm = (0, _preact.h)(_updatePanel2.default, { item: state.item, onUpdate: self.updateReport(), onBack: self.handleBack() });
      ...
      var table = function () {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(_table2.default, { items: state.items, onGet: self.getReport(), onDelete: self.deleteReport() })
        );
      }();
...
var _cardItemGroup = __webpack_require__(/*! ./card-item-group.jsx */ "./src/reports/card-item-group.jsx");
  ...
  _createClass(CreatePanel, [{
    ...
    value: function handleInsertGroup() {
      ...
      var fn = function fn() {
        ...
        if (line.length == 0) {
          if (groupInsert) {
            var isR = self.isRepeated(report, groupInsert);
            if (!isR) {
    ...
    value: function handleCreate() {
      ...
      var fn = function fn() {
        ...
        var o = _this3.getMinJSON(report);
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                'div',
                { id: 'report-panel', className: 'card-body' },
                (0, _preact.h)(
                  'div',
                  { className: 'row' },
                  (0, _preact.h)(
                    'div',
                    { className: 'col-md-8' },
                    (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-name', placeholder: 'Reporte' })
                  ),
                  (0, _preact.h)(
                    'div',
                    { className: 'col-md-4' },
  ...
  _createClass(RowTable, [{
    ...
    value: function handleDelete() {
      ...
      var fn = function fn() {
        ...
        var message = '\xBFDesea eliminar el reporte: ' + name + '?';
  ...
  _createClass(UpdatePanel, [{
    ...
    value: function handleUpdate() {
      ...
      var fn = function fn() {
        ...
        if (o.length == 0) {
          alert('La estructura del Reporte esta vacia');
          return;
        }

        var item = self.props.item;
        if (!item) {
          alert('Existe un error con la información del Reporte');
          return;
        }

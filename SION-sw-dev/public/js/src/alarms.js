...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/alarms/content.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var _table = __webpack_require__(/*! ./table.jsx */ "./src/alarms/table.jsx");

var _table2 = _interopRequireDefault(_table);

var _createForm = __webpack_require__(/*! ./create-form.jsx */ "./src/alarms/create-form.jsx");

var _createForm2 = _interopRequireDefault(_createForm);

var _updateForm = __webpack_require__(/*! ./update-form.jsx */ "./src/alarms/update-form.jsx");

var _updateForm2 = _interopRequireDefault(_updateForm);

var _optionsPanel = __webpack_require__(/*! ./options-panel.jsx */ "./src/alarms/options-panel.jsx");
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    ...
    key: 'getAlarmsForSearch',
    value: function getAlarmsForSearch(value) {
      var self = this;

      var url = _constants2.default.URL_SERVER_ALARMS + '/list?search=' + value;
    ...
    key: 'getAlarm',
    value: function getAlarm() {
      var self = this;

      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_ALARMS + '/' + json.id,
          type: _constants2.default.METHOD_GET,
          dataType: _constants2.default.JSON
        });
    ...
    value: function addAlarm() {
      ...
      var fn = function fn(json) {
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_ALARMS,
    ...
    value: function updateAlarm() {
      ...
      var fn = function fn(json, id) {
        ...
        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_ALARMS + '/' + id,
    ...
    key: 'updateOptionsAlarm',
    value: function updateOptionsAlarm() {
      var self = this;

      var fn = function fn(json, id) {

        var xhr = $.ajax({
          url: _constants2.default.URL_SERVER_ALARMS + '/' + id + '?update_relations=true',
          type: _constants2.default.METHOD_PUT,
          contentType: _constants2.default.APPLICATION_JSON,
          data: JSON.stringify(json)
        });
        ...
        if (evt.which == ENTER) {
          ...
          if (search) {
            if (search !== '') {
              ...
              self.getAlarmsForSearch(search);
            }
          }
        }
      };
    ...
    value: function render(props, state) {
      ...
      var createForm = (0, _preact.h)(_createForm2.default, { onCreate: self.addAlarm(), onBack: self.handleBack() });
      var updateForm = (0, _preact.h)(_updateForm2.default, { item: state.item, onUpdate: self.updateAlarm(), onBack: self.handleBack() });
      var optionsPanel = (0, _preact.h)(_optionsPanel2.default, { item: state.item, onUpdateOptions: self.updateOptionsAlarm(), onBack: self.handleBack() });
      ...
      var table = function () {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(_table2.default, { items: state.items, onGet: self.getAlarm(), onDelete: self.deleteAlarm(), onOptions: self.handleOptions() })
        );
      }();
  ...
  _createClass(CreateForm, [{
    ...
    value: function handleCreate() {
      ...
      var fn = function fn(evt) {
        ...
        var inputUnit = document.querySelector('#input-c-unit');
        var inputColor = document.querySelector('#input-c-color');
        var inputIsTimeout = document.querySelector('#input-c-is-timeout');
        var inputTimeout = document.querySelector('#input-c-timeout');
        var inputExpression = document.querySelector('#input-c-expression');
        var inputMessage = document.querySelector('#input-c-message');
        var inputSound = document.querySelector('#input-c-sound');
        var inputStatus = document.querySelector('#input-c-status');

        var name = inputName.value.trim();
        var unit = inputUnit.value.trim();
        var color = inputColor.value.trim();
        var is_timeout = inputIsTimeout.checked;
        var message = inputMessage.value.trim();
        var sound = inputStatus.value.trim();
    ...
    key: 'handleChangeTimeout',
    value: function handleChangeTimeout() {
      var self = this;
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-unit' },
                  'Unidad'
                ),
                (0, _preact.h)(
                  'select',
                  { id: 'input-c-unit', className: 'form-control' },
                  (0, _preact.h)(
                    'option',
                    { selected: true, value: '-1' },
                    'Unidad'
                  ),
                  state.units_.map(this.createOptUnit())
                )
              ),
              (0, _preact.h)(
                'div',
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-color' },
                  'Color'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-color', placeholder: 'Color' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-check' },
                (0, _preact.h)('input', { type: 'checkbox', 'class': 'form-check-input', id: 'input-c-is-timeout', onChange: this.handleChangeTimeout() }),
                (0, _preact.h)(
                  'label',
                  { 'class': 'form-check-label', htmlFor: 'input-c-is-timeout' },
                  'Tiempo de Espera'
                )
              ),
              (0, _preact.h)('br', null),
              (0, _preact.h)(
                'div',
                { className: 'form-group', hidden: !state.is_timeout },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-timeout' },
                  'Tiempo'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-c-timeout', placeholder: 'Tiempo (Minutos)' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group', hidden: state.is_timeout },
                (0, _preact.h)(
                  ...
                  'Expresi\xF3n Booleana',
                  (0, _preact.h)('br', null),
                  '${value}: Valor de la Variable'
                ),
                (0, _preact.h)('textarea', { className: 'form-control', id: 'input-c-expression', placeholder: 'Expresi\xF3n Booleana' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                ...
                (0, _preact.h)('textarea', { className: 'form-control', id: 'input-c-message', placeholder: 'Mensaje' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-c-sound' },
                  'Sonido'
                ),
                (0, _preact.h)(
                  'select',
                  { id: 'input-c-sound', className: 'form-control' },
                  (0, _preact.h)(
                    'option',
                    { selected: true, value: '-1' },
                    'Sin sonido'
...
var OptionsForm = function (_Component) {
  _inherits(OptionsForm, _Component);

  function OptionsForm(props) {
    _classCallCheck(this, OptionsForm);

    var _this = _possibleConstructorReturn(this, (OptionsForm.__proto__ || Object.getPrototypeOf(OptionsForm)).call(this, props));
  ...
  _createClass(OptionsForm, [{
    ...
    key: 'getVariablesForAlarm',
    value: function getVariablesForAlarm() {
      var self = this;

      var alarm = this.props.item;
      if (!alarm) {
        var msg = 'No se encontró la información de la alarma';
        alert(msg);
        return;
      }

      var url = _constants2.default.URL_SERVER_VARIABLES + '/list?alarm_id=' + alarm.id;
    ...
    key: 'getCustomVariablesForAlarm',
    value: function getCustomVariablesForAlarm() {
      var self = this;
      ...
      var url = _constants2.default.URL_SERVER_CUSTOM_VARIABLES + '/list?alarm_id=' + alarm.id;
    ...
    value: function handleUpdate(value) {
      ...
      var fn = function fn() {
        var alarm = self.props.item;
        if (!alarm) {
          alert('No se cuenta con la información de la alarma');
          return;
        }
        ...
        if (size == 0) {
          alert('La lista de elementos esta vacia, si desea eliminar los elementos, use el boton de limpiar');
          return;
        }
    ...
    value: function createItem(value) {
      ...
      var fn = function fn(item, index) {
        return (0, _preact.h)(
          ...
          (0, _preact.h)(
            'button',
            { type: 'button', className: 'close', 'data-dismiss': 'modal', 'aria-label': 'Close', onClick: self.handleRemove(item, value) },
            (0, _preact.h)(
              'span',
              { 'aria-hidden': 'true' },
              '\xD7'
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              'ul',
              { 'class': 'nav nav-tabs', id: 'tab-panel', role: 'tablist' },
              (0, _preact.h)(
                'li',
                { 'class': 'nav-item' },
                (0, _preact.h)(
                  'a',
                  { 'class': 'nav-link active', id: 'variables-tab', 'data-toggle': 'tab', href: '#variables', role: 'tab', 'aria-controls': 'variables', 'aria-selected': 'true' },
                  'Variables'
                )
              ),
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'a',
                  { 'class': 'nav-link', id: 'custom-variables-tab', 'data-toggle': 'tab', href: '#custom-variables', role: 'tab', 'aria-controls': 'custom-variables', 'aria-selected': 'true' },
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              'div',
              { 'class': 'tab-content', id: 'content-panel' },
              (0, _preact.h)(
                'div',
                { 'class': 'tab-pane fade show active', id: 'variables', role: 'tabpanel', 'aria-labelledby': 'variables-tab' },
                (0, _preact.h)(
                  'h4',
                  null,
                  'Variables'
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'select',
                      { 'class': 'form-control', id: 'input-variable' },
                      (0, _preact.h)(
                        'option',
                        null,
                        'Variables'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'button',
                      { type: 'button', className: 'btn btn-primary', onClick: this.handleInsert(VARIABLE) },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'add'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'button',
                      { type: 'button', className: 'btn btn-success', onClick: this.handleUpdate(VARIABLE) },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'save'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'button',
                      { type: 'button', className: 'btn btn-danger', onClick: this.handleUpdateClear(VARIABLE) },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'delete_sweep'
                  ...
                  (0, _preact.h)(
                    'div',
                    { className: 'col-md-12', style: { marginTop: '10px' } },
                    (0, _preact.h)(
                      'ul',
              ...
              (0, _preact.h)(
                'div',
                { 'class': 'tab-pane fade show', id: 'custom-variables', role: 'tabpanel', 'aria-labelledby': 'custom-variables-tab' },
                (0, _preact.h)(
                  'h4',
                  null,
                  'Variables personalizadas'
                ...
                (0, _preact.h)(
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'select',
                      { 'class': 'form-control', id: 'input-custom-variable' },
                      (0, _preact.h)(
                        'option',
                        null,
                        'Variables personalizadas'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'button',
                      { type: 'button', className: 'btn btn-primary', onClick: this.handleInsert(CUSTOM_VARIABLE) },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'add'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'button',
                      { type: 'button', className: 'btn btn-success', onClick: this.handleUpdate(CUSTOM_VARIABLE) },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'save'
                  ...
                  (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      'button',
                      { type: 'button', className: 'btn btn-danger', onClick: this.handleUpdateClear(CUSTOM_VARIABLE) },
                      (0, _preact.h)(
                        'i',
                        { className: 'material-icons' },
                        'delete_sweep'
...
exports.default = OptionsForm;

/***/ }),

/***/ "./src/alarms/table.jsx":
/*!******************************!*\
  !*** ./src/alarms/table.jsx ***!
  \******************************/
/*! no static exports found */
  ...
  _createClass(RowTable, [{
    ...
    value: function handleDelete() {
      ...
      var fn = function fn() {
        ...
        var message = '\xBFDesea eliminar la alarma: ' + name + '?';
    ...
    value: function render() {
      ...
      var sound = 'Sin sonido';
      if (row.sound == _constants2.default.WARNING_SOUND) {
        sound = 'Advertencia';
      } else if (row.sound == _constants2.default.DANGER_SOUND) {
        sound = 'Peligro';
      }
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            'button',
            { type: 'button', className: 'btn btn-primary', onClick: this.handleOptions() },
            (0, _preact.h)(
              'i',
              { className: 'material-icons' },
              'developer_board'
...
var Table = function (_Component2) {
  ...
  _createClass(Table, [{
    ...
    value: function createRow() {
      ...
      var fn = function fn(item, index) {
        item.index = index + 1;
        return (0, _preact.h)(RowTable, { key: item.id, row: item, onGet: self.handleGet(), onDelete: self.handleDelete(), onOptions: self.handleOptions() });
      };
...
var INSTRUCTIONS = '${name}: Nombre de la Alarma\n${variable}: Nombre de la Variable\n${value}: Valor de la Variable\n${timestamp}: Estampa de tiempo de la variable';
...
var UpdateForm = function (_Component) {
  ...
  _createClass(UpdateForm, [{
    ...
    value: function componentDidMount() {
      ...
      var inputColor = document.querySelector('#input-u-color');
      var inputMessage = document.querySelector('#input-u-message');
      ...
      if (o.is_timeout) {
        var inputIsTimeout = document.querySelector('#input-u-is-timeout');
    ...
    value: function getUnits() {
      ...
      xhr.done(function (res, status, response) {
        if (response.status == _constants2.default.STATUS_OK) {
          self.setState({ units_: res.docs }, function () {

            var o = _this2.props.item;
            if (o) {
              var inputUnit = document.querySelector('#input-u-unit');
    ...
    value: function handleUpdate() {
      ...
      var fn = function fn(evt) {
        ...
        var inputColor = document.querySelector('#input-u-color');
        var inputIsTimeout = document.querySelector('#input-u-is-timeout');
        var inputTimeout = document.querySelector('#input-u-timeout');
        var inputExpression = document.querySelector('#input-u-expression');
        var inputMessage = document.querySelector('#input-u-message');
        var inputSound = document.querySelector('#input-u-sound');
        var inputStatus = document.querySelector('#input-u-status');
        ...
        var is_timeout = inputIsTimeout.checked;
        var message = inputMessage.value.trim();
        var sound = inputSound.value.trim();
        var status = inputStatus.checked;
          ...
          (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-unit' },
                  'Unidad'
                ),
                (0, _preact.h)(
                  'select',
                  { id: 'input-u-unit', className: 'form-control' },
                  (0, _preact.h)(
                    'option',
                    { selected: true, value: '-1' },
                    'Unidad'
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-color' },
                  'Color'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-color', placeholder: 'Color' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-check' },
                (0, _preact.h)('input', { type: 'checkbox', 'class': 'form-check-input', id: 'input-u-is-timeout', onChange: this.handleChangeTimeout() }),
                (0, _preact.h)(
                  'label',
                  { 'class': 'form-check-label', htmlFor: 'input-u-is-timeout' },
                  'Tiempo de Espera'
                )
              ),
              (0, _preact.h)('br', null),
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-timeout' },
                  'Tiempo'
                ),
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-timeout', placeholder: 'Tiempo (Minutos)' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group', hidden: state.is_timeout },
                ...
                (0, _preact.h)('textarea', { className: 'form-control', id: 'input-u-expression', placeholder: 'Expresi\xF3n Booleana' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                ...
                (0, _preact.h)('input', { type: 'text', className: 'form-control', id: 'input-u-message', placeholder: 'Mensaje' })
              ),
              (0, _preact.h)(
                'div',
                { className: 'form-group' },
                (0, _preact.h)(
                  'label',
                  { htmlFor: 'input-u-sound' },
                  'Sonido'
                ),
                (0, _preact.h)(
                  'select',
                  { id: 'input-u-sound', className: 'form-control' },
                  (0, _preact.h)(
                    'option',
                    { selected: true, value: '-1' },
                    'Sin sonido'

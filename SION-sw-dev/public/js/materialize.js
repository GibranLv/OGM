...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, Materialize.Vel = Vel || Velocity,
  ...
  function (t) {
    ...
    t.fn.tabs_materialize = function (i) {
  ...
  function (t) {
    t(document).ready(function () {
      ...
      t(document).on("change", o, function (e) {
      ...
      }), t.fn.autocomplete_materialize = function (e) {
        var i = {
          data: {},
          limit: 1 / 0,
          onAutocomplete: null,
        ...
        return e = t.extend(i, e), this.each(function () {
          ...
          if (t.isEmptyObject(o)) n.off("keyup.autocomplete focus.autocomplete");
            ...
            n.off("blur.autocomplete_materialize").on("blur.autocomplete_materialize", function () {
              p()
  ...
  function (t) {
    ...
    t(document).ready(function () {
      ...
      n.hasAutocomplete = !t.isEmptyObject(o.autocompleteOptions.data), this.init = function () {
        ...
        }, r.autocomplete_materialize(o.autocompleteOptions))
      ...
      var y = !1,
        ...
        T = C.prototype = {
          ...
          open: function (i) {
            ...
            }, 100), !1 !== i && (b.open = !0, y && c.css("overflow", "hidden").css("padding-right", "+=" + n()), T.$root.eq(0).focus(), l.on("click." + b.id + " focusin." + b.id, function (t) {
              setTimeout(function(event) { var e = t.target;
              e != a && e != document && 3 != t.which && T.close(e === T.$root.children()[0])},0,event)
    ...
    o.DEFAULTS = {
      ...
      // setTimeout(function() {
        if (!this.isShown) {
          ...
          this.toggleView("hours"), this.locate(), this.isShown = !0, s.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, setTimeout(function (e) {
            var i = t(e.target);
            0 === i.closest(n.popover.find(".picker__wrap")).length && 0 === i.closest(n.input).length && n.hide()
          }, 200, e)), s.on("keyup.clockpicker." + this.id, function (t) {
            27 === t.keyCode && n.hide()

...
class Content extends Component {
  ...
  render(_, state) {
    ...
    let updatePanel = <UpdatePanel item={state.item} onUpdate={self.updateReport()} onBack={self.handleBack()} />
        ...
        <div>
          <div className="col s12">
            ...
            <div className="col s12 m8 busqueda">
              <input placeholder="Buscar..." type="text" onInput={self.handleChange()} onKeyUp={self.handleSearch()} />
            </div>
          </div>

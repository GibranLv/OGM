...
class Chart extends Component {
  ...
  componentDidMount() {
    ...
    let keyInput = `#input-variable-${chartKey}`;
    ...
    parallel({
      ...
      self.setState({ variables_: variables_, status_tools: status_tools }, () => {
        $(keyInput).val('');
        $('select').material_select();
        $(keyInput).on('change', self.handleChangeVariable());
  ...
  serviceWS() {
    ...
    self.ws = new w3cwebsocket(wsURL, constants.TTX_PROTOCOOL);
            ...
            <div className="col s12 m3">
              ...
              <div className="row">
                ...
                <div className="dates col s6 m6">
                  <input id={keyInputTimeOf} placeholder="Hora de:" type="text" value="00:00" className="timepicker" />
                </div>
              </div>
              <div className="row">
                <div id={keyInputContentDateTo} className="dates col s6 m6"></div>
                <div className="dates col s6 m6">
                  <input id={keyInputTimeTo} placeholder="Hora de:" type="text" value="00:00" className="timepicker" />
                </div>
              </div>
            </div>

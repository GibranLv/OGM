  ...
  handleInsert() {
    ...
    let fn = (evt) => {
      ...
      let variable_id = document
        .querySelector('#input-sp-variables')
        .value.trim()
  ...
  handleCreateEvent() {
    ...
    let fn = (evt) => {
      ...
      self.addEventChart(json, (err, doc) => {
        ...
        if (!err)
          self.state.chartEmitter.emit(constants.EVENT_INSERT_EVENT_CHART, doc)
        ...
        <div id='events-main-chart' className='modal modal_evento'>
          <div className='modal-content'>
            ...
            <div className='modal_box animated fadeIn'>
              ...
              <br />
              <form
                id='form-event-main-chart'
                className='formulario'
                onSubmit={this.handleCreateEvent()}
              >
                <div className='input-field col s12 m6'>
                  <input
                    id='input-name-event-main-chart'
                    type='text'
                    className='validate'
                    placeholder='Nombre'
                  />
                ...
                <div className='input-field col s12 m6'>
                  <input
                    id='input-description-event-main-chart'
                    type='text'
                    className='validate'
                ...
                <div className='dates col s12 m6'>
                  <input
                    id='input-variable-event-main-chart'
                ...
                <div className='dates col s12 m6'>
                  <input
                    id='input-created-at-event-main-chart'
                    placeholder='Fecha'
                    disabled='disabled'
                  />
                </div>
                <div className='file-field input-field col s12 m12'>
                  <div className='btn rojottx_btn' style='width: 20%;'>
                    <span>Subir</span>
                    <input
                      id='input-file-event-main-chart'
                      type='file'
                      multiple
                  ...
                  <div className='file-path-wrapper'>
                    <input
                      id='input-files-event-main-chart'
        ...
        <div id='setpoint-main-chart' className='modal modal_evento'>
          <div className='modal-content'>
            ...
            <div className='modal_box animated fadeIn'>
              ...
              <br />
              <form
                id='form-set-point-main-chart'
                className='formulario'
                onSubmit={this.handleInsertSetpoint()}
              >
                <div className='row'>
                  <div className='col s12 m5'>
                    <select
                      className='browser-default sion-select sion-margin-select'
                      id='input-sp-variables'

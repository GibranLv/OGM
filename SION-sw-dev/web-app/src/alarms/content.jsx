...
import OptionsPanel from './options-panel.jsx';
import CreateFormStatic from './create-form-static.jsx';
...
class Content extends Component {
  ...
  render(props, state) {
    ...
    let updateForm = <UpdateForm item={state.item} onUpdate={self.updateAlarm()} onBack={self.handleBack()} />
    let optionsPanel = <OptionsPanel item={state.item}
                                    onUpdateOptions={this.updateOptionsAlarm()}
                                    onUpdateNotification={this.updateNotificationAlarm()}
      ...
      return (
        <div>
          <div className="col s12">
            ...
            <div className="col s12 m3">
              <h5> &nbsp;&nbsp;
                <a href="#" className="waves-effect waves-light btn green darken-1" onClick={self.handleCreateStatic()}>

...
class Content extends Component {
  ...
  constructor(props) {
    ...
    this.state.chart24Emitter.on(constants.EVENT_VARIABLES, (variables, setpoints) => {
    ...
    this.state.chart24Emitter.on(constants.EVENT_OPEN_CREATE_EVENT_CHART, (json) => {
  ...
  // Evento de Graficas Anual
    this.state.chartAnnualEmitter.on(constants.EVENT_VARIABLES, (variables, setpoints) => {
      self.setState({ variables_: variables, variables: setpoints }, () => {
    ...
    this.state.chartAnnualEmitter.on(constants.EVENT_OPEN_CREATE_EVENT_CHART, (json) => {
  ...
  getRecords24hrsVariable() {
    ...
    let fn = (f) => {
      let variable_id = parseInt(VariableID);
  ...
  getRecordsAnnualVariable() {
    ...
    let fn = (f) => {
      ...
      let xhr = $.ajax({
        //url: `${constants.URL_SERVER_VARIABLES}/record/annual`,
        url: `${constants.URL_SERVER_VARIABLES}/record`,        
        type: constants.METHOD_POST,
        contentType: constants.APPLICATION_JSON,
        data: JSON.stringify(json)
  ...
  handleCreateEvent(key) {
    ...
    let fn = (evt) => {
      ...
      self.addEventChart(json, (err, doc) => {
        ...
        if (!err) {
          if (key === CHART_24) {
           self.state.chart24Emitter.emit(constants.EVENT_INSERT_EVENT_CHART, doc);

          } else if (key === CHART_ANNUAL) {
           self.state.chartAnnualEmitter.emit(constants.EVENT_INSERT_EVENT_CHART, doc);
          }
        }
    ...
    let fn = (item, index) => {
      return (
        <tr key={index}>
          ...
          <td>{item.unit}</td>
          <td>
            <a title="Borrar" className="btn-floating red" href="#" onClick={self.handleRemoveVariable(index)}>
  ...
  createItemFile() {
    ...
    let fn = (file, index) => {
      ...
      return <a key={index} href={url} target="_blank">{file}<br /></a>;
    };
      ...
      <div>
        ...
        <div id="events-24" className="modal modal_evento">
          <div className="modal-content">
            <i className="material-icons animated fadeInDown sion-modal-icon">date_range</i>
            <div className="modal_box animated fadeIn">
              <h5>Crear Evento</h5>
              <br />
              <form id="form-event-24" className="formulario" onSubmit={this.handleCreateEvent(CHART_24)}>
                <div className="input-field col s12 m6">
                  <input id="input-name-event-24" type="text" className="validate" placeholder="Nombre" />
                </div>
                <div className="input-field col s12 m6">
                  <input id="input-description-event-24" type="text" className="validate" placeholder="Descripción" />
                </div>
                <div className="dates col s12 m6">
                  <input id="input-variable-event-24" placeholder="Variable" disabled="disabled" />
                </div>
                <div className="dates col s12 m6">
                  <input id="input-created-at-event-24" placeholder="Fecha" disabled="disabled" />
                </div>
                <div className="file-field input-field col s12 m12">
                  <div className="btn rojottx_btn" style="width: 20%;">
                    <span>Subir</span>
                    <input id="input-file-event-24" type="file" multiple onChange={this.handleChangeFile()} />
                  </div>
                  <div className="file-path-wrapper">
                    <input id="input-files-event-24" className="file-path validate" type="text" placeholder="Subir un archivos" />
                  </div>
                </div>
        ...
        <div id="events-annual" className="modal modal_evento">
          <div className="modal-content">
            ...
            <div className="modal_box animated fadeIn">
              <h5>Crear Evento</h5>
              <br />
              <form id="form-event-annual" className="formulario" onSubmit={this.handleCreateEvent(CHART_ANNUAL)}>
                <div className="input-field col s12 m6">
                  <input id="input-name-event-annual" type="text" className="validate" placeholder="Nombre" />
                </div>
                <div className="input-field col s12 m6">
                  <input id="input-description-event-annual" type="text" className="validate" placeholder="Descripción" />
                </div>
                <div className="dates col s12 m6">
                  <input id="input-variable-event-annual" placeholder="Variable" disabled="disabled" />
                </div>
                <div className="dates col s12 m6">
                  <input id="input-created-at-event-annual" placeholder="Fecha" disabled="disabled" />
                </div>
                <div className="file-field input-field col s12 m12">
                  <div className="btn rojottx_btn" style="width: 20%;">
                    <span>Subir</span>
                    <input id="input-file-event-annual" type="file" multiple onChange={this.handleChangeFile()} />
                  </div>
                  <div className="file-path-wrapper">
                    <input id="input-files-event-annual" className="file-path validate" type="text" placeholder="Subir un archivos" />
                  </div>
                </div>
        ...
        <div id="setpoint-24" className="modal modal_evento">
          <div className="modal-content">
            ...
            <div className="modal_box animated fadeIn">
              <h5>Setpoints</h5>
              <br />
              <form id="form-set-point-24" className="formulario" onSubmit={this.handleInsertSetpoint(CHART_24)}>

                <div className="row">

                  <div className="col s12 m5">
                    <select className="browser-default sion-select sion-margin-select" id="input-sp-variables-24" onChange={this.handleChangeVariable()}>
                  ...
                  <div className="col s12 m5">
                    <select className="browser-default sion-select sion-margin-select" id="input-sp-alarms-24">
                      <option value="-1">Ninguno</option>
                  ...
                  <div className="col s12 m2">
                    <button type="button" className="btn blue" onClick={this.handleInsert(CHART_24)}>
                ...
                <div className="col s12 m12">
                  <br />
                  <button type="button" className="btn grey darken-3" onClick={this.handleBack(CHART_24)}>Cancelar</button>
                  <button type="submit" className="btn red">Aplicar</button>
                </div>
        ...
        <div id="setpoint-annual" className="modal modal_evento">
          <div className="modal-content">
            ...
            <div className="modal_box animated fadeIn">
              <h5>Setpoints</h5>
              <br />
              <form id="form-set-point-annual" className="formulario" onSubmit={this.handleInsertSetpoint(CHART_ANNUAL)}>

                <div className="row">

                  <div className="col s12 m5">
                    <select className="browser-default sion-select sion-margin-select" id="input-sp-variables-annual" onChange={this.handleChangeVariable()}>
                      <option value="-1">Ninguno</option>
                      {state.variables_.map(this.createOptVariable())}
                    </select>
                  </div>
                  ...
                  <div className="col s12 m5">
                    <select className="browser-default sion-select sion-margin-select" id="input-sp-alarms-annual">
                      <option value="-1">Ninguno</option>
                      {state.alarms_.map(this.createOptAlarm())}
                    </select>
                  </div>
                  ...
                  <div className="col s12 m2">
                    <button type="button" className="btn blue" onClick={this.handleInsert(CHART_ANNUAL)}>
                      <i className="material-icons">add</i>
                    </button>
                  </div>
                ...
                <div className="col s12 m12">
                  <br />
                  <button type="button" className="btn grey darken-3" onClick={this.handleBack(CHART_ANNUAL)}>Cancelar</button>
                  <button type="submit" className="btn red">Aplicar</button>
                </div>

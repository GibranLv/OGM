...
class CreateForm extends Component {
  ...
  initializePickers() {
    ...
    $('#input-created-at-c-date').on('change', (evt) => {
  ...
  handleCreate() {
    ...
    let fn = (evt) => {
      ...
      let f = self.props.onCreate;
      if (f) {
        let inputMatrix = document.querySelector('#input-c-matrix');
        let inputGroup = document.querySelector('#input-c-group');
        let inputTitle = document.querySelector('#input-c-title');
        let inputDescription = document.querySelector('#input-c-description');

        let inputCreatedAtDate = document.querySelector('#input-created-at-c-date');
        let inputCreatedAtTime = document.querySelector('#input-created-at-c-time');

        let date = inputCreatedAtDate.value.trim();
        let time = inputCreatedAtTime.value.trim();
  ...
  render(props, state) {
    return(
      <form className="formulario" onSubmit={this.handleCreate()}>
        <div className="all_notes">
          <div className="variable">
            <div className="col m12">
              <select className="browser-default sion-select" id="input-c-matrix" onChange={this.handleChangeMatrix()}>
            ...
            <div className="col m12">
              <select className="browser-default sion-select" id="input-c-group">
            ...
            <div className="col m12">
              <input type="text" id="input-c-title" placeholder="Titulo" />
            </div>
            <div className="col m12">
              <input type="text" id="input-c-description" placeholder="Descripción" />
            </div>
            <div className="col m12">
              <div id="content-created-at-c-date" className="dates col s6 m6"></div>
              <div className="dates col s6 m6">
                <input id="input-created-at-c-time" placeholder="Hora" type="text" className="timepicker" />
              </div>
            </div>
            <div className="row">
              <div className="col m12">

            ...
            <form onSubmit={this.handleCreate()} >
              ...
              <div className="row">
                ...
                <div className="input-field col s12 m3">
                  <input type="text" id="input-c-name-HiHi" placeholder="Nombre" value="HiHi" />
              ...
              <div className="row">
                ...
                <div className="input-field col s12 m3">
                  <input type="text" id="input-c-name-Hi" placeholder="Nombre" value="Hi" />
                ...
                <div className="input-field col s12 m2">
                  <input className="sion-input-color" type="color" id="input-c-color-Hi" value="#FA0404" placeholder="Color" />
              ...
              <div className="row">
                ...
                <div className="input-field col s12 m3">
                  <input type="text" id="input-c-name-Lo" placeholder="Nombre" value="Lo" />
              ...
              <div className="row">
                ...
                <div className="input-field col s12 m3">
                  <input type="text" id="input-c-name-LoLo" placeholder="Nombre" value="LoLo" />
                ...
                <div className="input-field col s12 m2">
                  <input className="sion-input-color" type="color" id="input-c-color-LoLo" value="#FF9900" placeholder="Color" />

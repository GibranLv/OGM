...
class Content extends Component {
  ...
  render(props, state) {
    ...
    let updateForm = <UpdateForm item={state.item} onUpdate={self.updateUser()} onBack={self.handleBack()} />
    let optionsPanel = <OptionsPanel item={state.item} onUpdateOptions={self.updateOptionsUser()} onBack={self.handleBack()} />

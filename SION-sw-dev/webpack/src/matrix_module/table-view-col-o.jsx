    ...
    let fn = (title, index) => {
      ...
      if (value === 0) {
        if (!hasFG) {
          ...
          return <th colSpan={flows} key={index}>FLUJO DE GAS (MMPCD)</th>;
        }
      ...
      if (value === 0) {
        if (!hasTEMP) {
          ...
          return <th colSpan={temps} key={index}>TEMPERATURA DE (°F)</th>;
        }
  ...
  render(props, state) {
    ...
    return (
      <div className="col s12 m12 body_int">
        ...
        <div class="DashInter">
          <table class="responsive-table" style="border-collapse: collapse;">
            <thead>
              <tr>

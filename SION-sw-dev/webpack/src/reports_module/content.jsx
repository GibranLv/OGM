...
class Content extends Component {
  ...
  createOptReport(prefix) {
    ...
    let fn = (item, index) => {
      ...
      return <option key={index} value={item.id}>{name}</option>;
    };
                  ...
                  <ul className="collapsible popout" data-collapsible="expandable">
                    <li>
                      ...
                      <div className="collapsible-body">
                        <form className="formulario" onSubmit={this.handleCreate(DAILY)} >
                          <div className="all_notes">

                            <div className="variable">
                              <label htmlFor="input-d-report">Reporte</label>
                              <select className="browser-default sion-select" id="input-d-report">
                                <option value="" disabled selected>Reporte</option>
                                {state.reports_.map(this.createOptReport(DAILY_PREFIX))}
                              </select>
                            </div>

                            <div className="variable">
                              <div className="row">
                                <div id="content-input-d-date" className="input-field col s12">
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row">
                              <div className=" col s12 m12">
                                <div className="btn_ttx green">
                                  <button id="btn-daily">
                                    <i className="material-icons prefix left ">file_download</i>
                                    Generar
                                  </button>
                                </div>
                              </div>
													...
													<li>
														<div className="collapsible-header">
															<h4>
																...
																<br />Reporte Personalizado
															</h4>
														</div>

														<div className="collapsible-body">
															<form className="formulario" onSubmit={this.handleCreate(CUSTOM)} >
																<div className="all_notes">
																	<div className="variable">
																		<label htmlFor="input-c-report">Reporte</label>
																		<select className="browser-default sion-select" id="input-c-report">
																			<option value="" disabled selected>Reporte</option>
																			{state.reports_.map(this.createOptReport(CUSTOM_PREFIX))}
																		</select>
																	</div>

																	<div className="row">
																		<div id="content-input-c-date-of" className="input-field col s6">
																		</div>

																		<div className="input-field col s6">
																			<label htmlFor="input-c-time-of">Hora de</label>
																			{ /*<input type="text" id="input-c-time-of" className="timepicker" /> */ }

                 											<input id="input-c-time-of" value="00:00" className={ window.SYSTEM_HOST !== 'scada.technotex.com' ? "timepicker" : "" }
												 										 type={ window.SYSTEM_HOST !== 'scada.technotex.com' ? "text" : "time" } />
																		</div>
																	</div>

																	<div className="row">
																		<div id="content-input-c-date-to" className="input-field col s6">
																		</div>

																		<div className="input-field col s6">
																			<label htmlFor="input-c-time-to">Hora de</label>
																			{ /*<input type="text" id="input-c-time-to" className="timepicker" />*/ }

                 											<input id="input-c-time-to" value="00:00" className={ window.SYSTEM_HOST !== 'scada.technotex.com' ? "timepicker" : "" }
												 										 type={ window.SYSTEM_HOST !== 'scada.technotex.com' ? "text" : "time" } />
																		</div>
																	</div>
																	...
																	<div className="variable">
																		...
																		<select className="browser-default sion-select" id="input-c-type">
											...
											<div className="col s12 m3 reportes">
												<ul className="collapsible popout" data-collapsible="expandable">
													<li>
														...
														<div className="collapsible-body">
															<form className="formulario" onSubmit={this.handleCreate(MONTHLY)} >
																<div className="all_notes">

																	<div className="variable">
																		<label htmlFor="input-m-report">Reporte</label>
																		<select className="browser-default sion-select" id="input-m-report">
																			<option value="" disabled selected>Reporte</option>
																			{state.reports_.map(this.createOptReport(MONTHLY_PREFIX))}
																		</select>
																	</div>

																	<div className="row">
																		<div id="content-input-m-date-of" className="input-field col s12">
																		</div>
																	</div>

																	<div className="row">
																		<div id="content-input-m-date-to" className="input-field col s12">
																		</div>
																	</div>

																	<div className="variable">
																		<label htmlFor="input-m-type">Tipo</label>
																		<select className="browser-default sion-select" id="input-m-type">
																			<option value="" selected>POR DIA</option>
											...
											<div className="col s12 m3 reportes">
												<ul className="collapsible popout" data-collapsible="expandable">
													<li>
														...
														<div className="collapsible-body">
															<form className="formulario" onSubmit={this.handleCreate(ANNUAL)} >
																<div className="all_notes">

																	<div className="variable">
																		<label htmlFor="input-a-report">Reporte</label>
																		<select className="browser-default sion-select" id="input-a-report">
																			<option value="" disabled selected>Reporte</option>
																	...
																	<div className="variable">
																		...
																		<select className="browser-default sion-select" id="input-a-year">
